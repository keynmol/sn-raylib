...
object enumerations:
  import predef.*
  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  ...
  object ConfigFlags extends CEnumU[ConfigFlags]:
    ...
    inline def getName(inline value: ConfigFlags): Option[String] =
      inline value match
        ...
        case FLAG_WINDOW_MOUSE_PASSTHROUGH => Some("FLAG_WINDOW_MOUSE_PASSTHROUGH")
        case FLAG_BORDERLESS_WINDOWED_MODE => Some("FLAG_BORDERLESS_WINDOWED_MODE")
  ...
  object CubemapLayout extends CEnumU[CubemapLayout]:
    ...
    inline def getName(inline value: CubemapLayout): Option[String] =
      inline value match
        ...
        case CUBEMAP_LAYOUT_LINE_HORIZONTAL => Some("CUBEMAP_LAYOUT_LINE_HORIZONTAL")
        case CUBEMAP_LAYOUT_CROSS_THREE_BY_FOUR => Some("CUBEMAP_LAYOUT_CROSS_THREE_BY_FOUR")
        case CUBEMAP_LAYOUT_CROSS_FOUR_BY_THREE => Some("CUBEMAP_LAYOUT_CROSS_FOUR_BY_THREE")
  ...
  object GamepadButton extends CEnumU[GamepadButton]:
    ...
    inline def getName(inline value: GamepadButton): Option[String] =
      inline value match
        ...
        case GAMEPAD_BUTTON_LEFT_FACE_RIGHT => Some("GAMEPAD_BUTTON_LEFT_FACE_RIGHT")
        case GAMEPAD_BUTTON_LEFT_FACE_DOWN => Some("GAMEPAD_BUTTON_LEFT_FACE_DOWN")
        case GAMEPAD_BUTTON_LEFT_FACE_LEFT => Some("GAMEPAD_BUTTON_LEFT_FACE_LEFT")
        case GAMEPAD_BUTTON_RIGHT_FACE_UP => Some("GAMEPAD_BUTTON_RIGHT_FACE_UP")
        case GAMEPAD_BUTTON_RIGHT_FACE_RIGHT => Some("GAMEPAD_BUTTON_RIGHT_FACE_RIGHT")
        case GAMEPAD_BUTTON_RIGHT_FACE_DOWN => Some("GAMEPAD_BUTTON_RIGHT_FACE_DOWN")
        case GAMEPAD_BUTTON_RIGHT_FACE_LEFT => Some("GAMEPAD_BUTTON_RIGHT_FACE_LEFT")
        case GAMEPAD_BUTTON_LEFT_TRIGGER_1 => Some("GAMEPAD_BUTTON_LEFT_TRIGGER_1")
        case GAMEPAD_BUTTON_LEFT_TRIGGER_2 => Some("GAMEPAD_BUTTON_LEFT_TRIGGER_2")
        case GAMEPAD_BUTTON_RIGHT_TRIGGER_1 => Some("GAMEPAD_BUTTON_RIGHT_TRIGGER_1")
        case GAMEPAD_BUTTON_RIGHT_TRIGGER_2 => Some("GAMEPAD_BUTTON_RIGHT_TRIGGER_2")
  ...
  object NPatchLayout extends CEnumU[NPatchLayout]:
    ...
    inline def getName(inline value: NPatchLayout): Option[String] =
      inline value match
        ...
        case NPATCH_THREE_PATCH_HORIZONTAL => Some("NPATCH_THREE_PATCH_HORIZONTAL")
        case _ => _root_.scala.None
  ...
  */
  ...
  object PixelFormat extends CEnumU[PixelFormat]:
    ...
    inline def getName(inline value: PixelFormat): Option[String] =
      inline value match
        case PIXELFORMAT_UNCOMPRESSED_GRAYSCALE => Some("PIXELFORMAT_UNCOMPRESSED_GRAYSCALE")
        case PIXELFORMAT_UNCOMPRESSED_GRAY_ALPHA => Some("PIXELFORMAT_UNCOMPRESSED_GRAY_ALPHA")
        case PIXELFORMAT_UNCOMPRESSED_R5G6B5 => Some("PIXELFORMAT_UNCOMPRESSED_R5G6B5")
        case PIXELFORMAT_UNCOMPRESSED_R8G8B8 => Some("PIXELFORMAT_UNCOMPRESSED_R8G8B8")
        case PIXELFORMAT_UNCOMPRESSED_R5G5B5A1 => Some("PIXELFORMAT_UNCOMPRESSED_R5G5B5A1")
        case PIXELFORMAT_UNCOMPRESSED_R4G4B4A4 => Some("PIXELFORMAT_UNCOMPRESSED_R4G4B4A4")
        case PIXELFORMAT_UNCOMPRESSED_R8G8B8A8 => Some("PIXELFORMAT_UNCOMPRESSED_R8G8B8A8")
        case PIXELFORMAT_UNCOMPRESSED_R32 => Some("PIXELFORMAT_UNCOMPRESSED_R32")
        case PIXELFORMAT_UNCOMPRESSED_R32G32B32 => Some("PIXELFORMAT_UNCOMPRESSED_R32G32B32")
        case PIXELFORMAT_UNCOMPRESSED_R32G32B32A32 => Some("PIXELFORMAT_UNCOMPRESSED_R32G32B32A32")
        case PIXELFORMAT_UNCOMPRESSED_R16 => Some("PIXELFORMAT_UNCOMPRESSED_R16")
        case PIXELFORMAT_UNCOMPRESSED_R16G16B16 => Some("PIXELFORMAT_UNCOMPRESSED_R16G16B16")
        case PIXELFORMAT_UNCOMPRESSED_R16G16B16A16 => Some("PIXELFORMAT_UNCOMPRESSED_R16G16B16A16")
        case PIXELFORMAT_COMPRESSED_DXT1_RGB => Some("PIXELFORMAT_COMPRESSED_DXT1_RGB")
        case PIXELFORMAT_COMPRESSED_DXT1_RGBA => Some("PIXELFORMAT_COMPRESSED_DXT1_RGBA")
        case PIXELFORMAT_COMPRESSED_DXT3_RGBA => Some("PIXELFORMAT_COMPRESSED_DXT3_RGBA")
        case PIXELFORMAT_COMPRESSED_DXT5_RGBA => Some("PIXELFORMAT_COMPRESSED_DXT5_RGBA")
        case PIXELFORMAT_COMPRESSED_ETC1_RGB => Some("PIXELFORMAT_COMPRESSED_ETC1_RGB")
        case PIXELFORMAT_COMPRESSED_ETC2_RGB => Some("PIXELFORMAT_COMPRESSED_ETC2_RGB")
        case PIXELFORMAT_COMPRESSED_ETC2_EAC_RGBA => Some("PIXELFORMAT_COMPRESSED_ETC2_EAC_RGBA")
        case PIXELFORMAT_COMPRESSED_PVRT_RGB => Some("PIXELFORMAT_COMPRESSED_PVRT_RGB")
        case PIXELFORMAT_COMPRESSED_PVRT_RGBA => Some("PIXELFORMAT_COMPRESSED_PVRT_RGBA")
        case PIXELFORMAT_COMPRESSED_ASTC_4x4_RGBA => Some("PIXELFORMAT_COMPRESSED_ASTC_4x4_RGBA")
        case PIXELFORMAT_COMPRESSED_ASTC_8x8_RGBA => Some("PIXELFORMAT_COMPRESSED_ASTC_8x8_RGBA")
        case _ => _root_.scala.None
  ...
  object TextureFilter extends CEnumU[TextureFilter]:
    ...
    inline def getName(inline value: TextureFilter): Option[String] =
      inline value match
        ...
        case TEXTURE_FILTER_ANISOTROPIC_4X => Some("TEXTURE_FILTER_ANISOTROPIC_4X")
        case TEXTURE_FILTER_ANISOTROPIC_8X => Some("TEXTURE_FILTER_ANISOTROPIC_8X")
        case TEXTURE_FILTER_ANISOTROPIC_16X => Some("TEXTURE_FILTER_ANISOTROPIC_16X")
        case _ => _root_.scala.None
...
private[libraylib] object extern_functions:
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def CompressData(data : Ptr[CUnsignedChar], dataSize : CInt, compDataSize : Ptr[CInt]): Ptr[CUnsignedChar] = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DecodeDataBase64(data : Ptr[CUnsignedChar], outputSize : Ptr[CInt]): Ptr[CUnsignedChar] = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DecompressData(compData : Ptr[CUnsignedChar], compDataSize : CInt, dataSize : Ptr[CInt]): Ptr[CUnsignedChar] = extern
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def EncodeDataBase64(data : Ptr[CUnsignedChar], dataSize : CInt, outputSize : Ptr[CInt]): CString = extern
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ExportDataAsCode(data : Ptr[CUnsignedChar], dataSize : CInt, fileName : CString): Boolean = extern
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetCodepointPrevious(text : CString, codepointSize : Ptr[CInt]): CInt = extern
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageKernelConvolution(image : Ptr[Image], kernel : Ptr[Float], kernelSize : CInt): Unit = extern
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadFileData(fileName : CString, dataSize : Ptr[CInt]): Ptr[CUnsignedChar] = extern
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadFontData(fileData : Ptr[CUnsignedChar], dataSize : CInt, fontSize : CInt, codepoints : Ptr[CInt], codepointCount : CInt, `type` : CInt): Ptr[GlyphInfo] = extern
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadModelAnimations(fileName : CString, animCount : Ptr[CInt]): Ptr[ModelAnimation] = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadRandomSequence(count : CUnsignedInt, min : CInt, max : CInt): Ptr[CInt] = extern
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def SaveFileData(fileName : CString, data : Ptr[Byte], dataSize : CInt): Boolean = extern
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def SetGamepadVibration(gamepad : CInt, leftMotor : Float, rightMotor : Float): Unit = extern
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def UnloadModelAnimations(animations : Ptr[ModelAnimation], animCount : CInt): Unit = extern
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def WaveCrop(wave : Ptr[Wave], initFrame : CInt, finalFrame : CInt): Unit = extern
  ...
  */
  ...
  private[libraylib] def __sn_wrap_libraylib_AttachAudioStreamProcessor(stream : Ptr[AudioStream], processor : AudioCallback): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_BeginMode2D(camera : Ptr[Camera2D]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_BeginMode3D(camera : Ptr[Camera3D]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_BeginShaderMode(shader : Ptr[Shader]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_BeginTextureMode(target : Ptr[RenderTexture2D]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_BeginVrStereoMode(config : Ptr[VrStereoConfig]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_CheckCollisionBoxSphere(box : Ptr[BoundingBox], center : Ptr[Vector3], radius : Float): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_CheckCollisionBoxes(box1 : Ptr[BoundingBox], box2 : Ptr[BoundingBox]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_CheckCollisionCircleLine(center : Ptr[Vector2], radius : Float, p1 : Ptr[Vector2], p2 : Ptr[Vector2]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_CheckCollisionCircleRec(center : Ptr[Vector2], radius : Float, rec : Ptr[Rectangle]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_CheckCollisionCircles(center1 : Ptr[Vector2], radius1 : Float, center2 : Ptr[Vector2], radius2 : Float): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_CheckCollisionLines(startPos1 : Ptr[Vector2], endPos1 : Ptr[Vector2], startPos2 : Ptr[Vector2], endPos2 : Ptr[Vector2], collisionPoint : Ptr[Vector2]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_CheckCollisionPointCircle(point : Ptr[Vector2], center : Ptr[Vector2], radius : Float): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_CheckCollisionPointLine(point : Ptr[Vector2], p1 : Ptr[Vector2], p2 : Ptr[Vector2], threshold : CInt): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_CheckCollisionPointPoly(point : Ptr[Vector2], points : Ptr[Vector2], pointCount : CInt): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_CheckCollisionPointRec(point : Ptr[Vector2], rec : Ptr[Rectangle]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_CheckCollisionPointTriangle(point : Ptr[Vector2], p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_CheckCollisionRecs(rec1 : Ptr[Rectangle], rec2 : Ptr[Rectangle]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_CheckCollisionSpheres(center1 : Ptr[Vector3], radius1 : Float, center2 : Ptr[Vector3], radius2 : Float): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_ClearBackground(color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ColorAlpha(color : Ptr[Color], alpha : Float, __return : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ColorAlphaBlend(dst : Ptr[Color], src : Ptr[Color], tint : Ptr[Color], __return : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ColorBrightness(color : Ptr[Color], factor : Float, __return : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ColorContrast(color : Ptr[Color], contrast : Float, __return : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ColorFromHSV(hue : Float, saturation : Float, value : Float, __return : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ColorFromNormalized(normalized : Ptr[Vector4], __return : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ColorIsEqual(col1 : Ptr[Color], col2 : Ptr[Color]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_ColorNormalize(color : Ptr[Color], __return : Ptr[Vector4]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ColorTint(color : Ptr[Color], tint : Ptr[Color], __return : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ColorToHSV(color : Ptr[Color], __return : Ptr[Vector3]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ColorToInt(color : Ptr[Color]): CInt = extern

  private[libraylib] def __sn_wrap_libraylib_DetachAudioStreamProcessor(stream : Ptr[AudioStream], processor : AudioCallback): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawBillboard(camera : Ptr[Camera], texture : Ptr[Texture2D], position : Ptr[Vector3], scale : Float, tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawBillboardPro(camera : Ptr[Camera], texture : Ptr[Texture2D], source : Ptr[Rectangle], position : Ptr[Vector3], up : Ptr[Vector3], size : Ptr[Vector2], origin : Ptr[Vector2], rotation : Float, tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawBillboardRec(camera : Ptr[Camera], texture : Ptr[Texture2D], source : Ptr[Rectangle], position : Ptr[Vector3], size : Ptr[Vector2], tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawBoundingBox(box : Ptr[BoundingBox], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCapsule(startPos : Ptr[Vector3], endPos : Ptr[Vector3], radius : Float, slices : CInt, rings : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCapsuleWires(startPos : Ptr[Vector3], endPos : Ptr[Vector3], radius : Float, slices : CInt, rings : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCircle(centerX : CInt, centerY : CInt, radius : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCircle3D(center : Ptr[Vector3], radius : Float, rotationAxis : Ptr[Vector3], rotationAngle : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCircleGradient(centerX : CInt, centerY : CInt, radius : Float, inner : Ptr[Color], outer : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCircleLines(centerX : CInt, centerY : CInt, radius : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCircleLinesV(center : Ptr[Vector2], radius : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCircleSector(center : Ptr[Vector2], radius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCircleSectorLines(center : Ptr[Vector2], radius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCircleV(center : Ptr[Vector2], radius : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCube(position : Ptr[Vector3], width : Float, height : Float, length : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCubeV(position : Ptr[Vector3], size : Ptr[Vector3], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCubeWires(position : Ptr[Vector3], width : Float, height : Float, length : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCubeWiresV(position : Ptr[Vector3], size : Ptr[Vector3], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCylinder(position : Ptr[Vector3], radiusTop : Float, radiusBottom : Float, height : Float, slices : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCylinderEx(startPos : Ptr[Vector3], endPos : Ptr[Vector3], startRadius : Float, endRadius : Float, sides : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCylinderWires(position : Ptr[Vector3], radiusTop : Float, radiusBottom : Float, height : Float, slices : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawCylinderWiresEx(startPos : Ptr[Vector3], endPos : Ptr[Vector3], startRadius : Float, endRadius : Float, sides : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawEllipse(centerX : CInt, centerY : CInt, radiusH : Float, radiusV : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawEllipseLines(centerX : CInt, centerY : CInt, radiusH : Float, radiusV : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawLine(startPosX : CInt, startPosY : CInt, endPosX : CInt, endPosY : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawLine3D(startPos : Ptr[Vector3], endPos : Ptr[Vector3], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawLineBezier(startPos : Ptr[Vector2], endPos : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawLineEx(startPos : Ptr[Vector2], endPos : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawLineStrip(points : Ptr[Vector2], pointCount : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawLineV(startPos : Ptr[Vector2], endPos : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawMesh(mesh : Ptr[Mesh], material : Ptr[Material], transform : Ptr[Matrix]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawMeshInstanced(mesh : Ptr[Mesh], material : Ptr[Material], transforms : Ptr[Matrix], instances : CInt): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawModel(model : Ptr[Model], position : Ptr[Vector3], scale : Float, tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawModelEx(model : Ptr[Model], position : Ptr[Vector3], rotationAxis : Ptr[Vector3], rotationAngle : Float, scale : Ptr[Vector3], tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawModelWires(model : Ptr[Model], position : Ptr[Vector3], scale : Float, tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawModelWiresEx(model : Ptr[Model], position : Ptr[Vector3], rotationAxis : Ptr[Vector3], rotationAngle : Float, scale : Ptr[Vector3], tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawPixel(posX : CInt, posY : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawPixelV(position : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawPlane(centerPos : Ptr[Vector3], size : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawPoint3D(position : Ptr[Vector3], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawPoly(center : Ptr[Vector2], sides : CInt, radius : Float, rotation : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawPolyLines(center : Ptr[Vector2], sides : CInt, radius : Float, rotation : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawPolyLinesEx(center : Ptr[Vector2], sides : CInt, radius : Float, rotation : Float, lineThick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRay(ray : Ptr[Ray], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRectangle(posX : CInt, posY : CInt, width : CInt, height : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRectangleGradientEx(rec : Ptr[Rectangle], topLeft : Ptr[Color], bottomLeft : Ptr[Color], topRight : Ptr[Color], bottomRight : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRectangleGradientH(posX : CInt, posY : CInt, width : CInt, height : CInt, left : Ptr[Color], right : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRectangleGradientV(posX : CInt, posY : CInt, width : CInt, height : CInt, top : Ptr[Color], bottom : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRectangleLines(posX : CInt, posY : CInt, width : CInt, height : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRectangleLinesEx(rec : Ptr[Rectangle], lineThick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRectanglePro(rec : Ptr[Rectangle], origin : Ptr[Vector2], rotation : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRectangleRec(rec : Ptr[Rectangle], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRectangleRounded(rec : Ptr[Rectangle], roundness : Float, segments : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRectangleRoundedLines(rec : Ptr[Rectangle], roundness : Float, segments : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRectangleRoundedLinesEx(rec : Ptr[Rectangle], roundness : Float, segments : CInt, lineThick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRectangleV(position : Ptr[Vector2], size : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRing(center : Ptr[Vector2], innerRadius : Float, outerRadius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawRingLines(center : Ptr[Vector2], innerRadius : Float, outerRadius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawSphere(centerPos : Ptr[Vector3], radius : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawSphereEx(centerPos : Ptr[Vector3], radius : Float, rings : CInt, slices : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawSphereWires(centerPos : Ptr[Vector3], radius : Float, rings : CInt, slices : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawSplineBasis(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawSplineBezierCubic(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawSplineBezierQuadratic(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawSplineCatmullRom(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawSplineLinear(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawSplineSegmentBasis(p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2], p4 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawSplineSegmentBezierCubic(p1 : Ptr[Vector2], c2 : Ptr[Vector2], c3 : Ptr[Vector2], p4 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawSplineSegmentBezierQuadratic(p1 : Ptr[Vector2], c2 : Ptr[Vector2], p3 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawSplineSegmentCatmullRom(p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2], p4 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawSplineSegmentLinear(p1 : Ptr[Vector2], p2 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawText(text : CString, posX : CInt, posY : CInt, fontSize : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTextCodepoint(font : Ptr[Font], codepoint : CInt, position : Ptr[Vector2], fontSize : Float, tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTextCodepoints(font : Ptr[Font], codepoints : Ptr[CInt], codepointCount : CInt, position : Ptr[Vector2], fontSize : Float, spacing : Float, tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTextEx(font : Ptr[Font], text : CString, position : Ptr[Vector2], fontSize : Float, spacing : Float, tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTextPro(font : Ptr[Font], text : CString, position : Ptr[Vector2], origin : Ptr[Vector2], rotation : Float, fontSize : Float, spacing : Float, tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTexture(texture : Ptr[Texture2D], posX : CInt, posY : CInt, tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTextureEx(texture : Ptr[Texture2D], position : Ptr[Vector2], rotation : Float, scale : Float, tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTextureNPatch(texture : Ptr[Texture2D], nPatchInfo : Ptr[NPatchInfo], dest : Ptr[Rectangle], origin : Ptr[Vector2], rotation : Float, tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTexturePro(texture : Ptr[Texture2D], source : Ptr[Rectangle], dest : Ptr[Rectangle], origin : Ptr[Vector2], rotation : Float, tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTextureRec(texture : Ptr[Texture2D], source : Ptr[Rectangle], position : Ptr[Vector2], tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTextureV(texture : Ptr[Texture2D], position : Ptr[Vector2], tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTriangle(v1 : Ptr[Vector2], v2 : Ptr[Vector2], v3 : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTriangle3D(v1 : Ptr[Vector3], v2 : Ptr[Vector3], v3 : Ptr[Vector3], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTriangleFan(points : Ptr[Vector2], pointCount : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTriangleLines(v1 : Ptr[Vector2], v2 : Ptr[Vector2], v3 : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTriangleStrip(points : Ptr[Vector2], pointCount : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_DrawTriangleStrip3D(points : Ptr[Vector3], pointCount : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ExportAutomationEventList(list : Ptr[AutomationEventList], fileName : CString): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_ExportFontAsCode(font : Ptr[Font], fileName : CString): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_ExportImage(image : Ptr[Image], fileName : CString): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_ExportImageAsCode(image : Ptr[Image], fileName : CString): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_ExportImageToMemory(image : Ptr[Image], fileType : CString, fileSize : Ptr[CInt]): Ptr[CUnsignedChar] = extern

  private[libraylib] def __sn_wrap_libraylib_ExportMesh(mesh : Ptr[Mesh], fileName : CString): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_ExportMeshAsCode(mesh : Ptr[Mesh], fileName : CString): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_ExportWave(wave : Ptr[Wave], fileName : CString): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_ExportWaveAsCode(wave : Ptr[Wave], fileName : CString): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_Fade(color : Ptr[Color], alpha : Float, __return : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenImageCellular(width : CInt, height : CInt, tileSize : CInt, __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenImageChecked(width : CInt, height : CInt, checksX : CInt, checksY : CInt, col1 : Ptr[Color], col2 : Ptr[Color], __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenImageColor(width : CInt, height : CInt, color : Ptr[Color], __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenImageFontAtlas(glyphs : Ptr[GlyphInfo], glyphRecs : Ptr[Ptr[Rectangle]], glyphCount : CInt, fontSize : CInt, padding : CInt, packMethod : CInt, __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenImageGradientLinear(width : CInt, height : CInt, direction : CInt, start : Ptr[Color], end : Ptr[Color], __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenImageGradientRadial(width : CInt, height : CInt, density : Float, inner : Ptr[Color], outer : Ptr[Color], __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenImageGradientSquare(width : CInt, height : CInt, density : Float, inner : Ptr[Color], outer : Ptr[Color], __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenImagePerlinNoise(width : CInt, height : CInt, offsetX : CInt, offsetY : CInt, scale : Float, __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenImageText(width : CInt, height : CInt, text : CString, __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenImageWhiteNoise(width : CInt, height : CInt, factor : Float, __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenMeshCone(radius : Float, height : Float, slices : CInt, __return : Ptr[Mesh]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenMeshCube(width : Float, height : Float, length : Float, __return : Ptr[Mesh]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenMeshCubicmap(cubicmap : Ptr[Image], cubeSize : Ptr[Vector3], __return : Ptr[Mesh]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenMeshCylinder(radius : Float, height : Float, slices : CInt, __return : Ptr[Mesh]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenMeshHeightmap(heightmap : Ptr[Image], size : Ptr[Vector3], __return : Ptr[Mesh]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenMeshHemiSphere(radius : Float, rings : CInt, slices : CInt, __return : Ptr[Mesh]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenMeshKnot(radius : Float, size : Float, radSeg : CInt, sides : CInt, __return : Ptr[Mesh]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenMeshPlane(width : Float, length : Float, resX : CInt, resZ : CInt, __return : Ptr[Mesh]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenMeshPoly(sides : CInt, radius : Float, __return : Ptr[Mesh]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenMeshSphere(radius : Float, rings : CInt, slices : CInt, __return : Ptr[Mesh]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GenMeshTorus(radius : Float, size : Float, radSeg : CInt, sides : CInt, __return : Ptr[Mesh]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetCameraMatrix(camera : Ptr[Camera], __return : Ptr[Matrix]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetCameraMatrix2D(camera : Ptr[Camera2D], __return : Ptr[Matrix]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetCollisionRec(rec1 : Ptr[Rectangle], rec2 : Ptr[Rectangle], __return : Ptr[Rectangle]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetColor(hexValue : CUnsignedInt, __return : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetFontDefault(__return : Ptr[Font]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetGestureDragVector(__return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetGesturePinchVector(__return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetGlyphAtlasRec(font : Ptr[Font], codepoint : CInt, __return : Ptr[Rectangle]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetGlyphIndex(font : Ptr[Font], codepoint : CInt): CInt = extern

  private[libraylib] def __sn_wrap_libraylib_GetGlyphInfo(font : Ptr[Font], codepoint : CInt, __return : Ptr[GlyphInfo]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetImageAlphaBorder(image : Ptr[Image], threshold : Float, __return : Ptr[Rectangle]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetImageColor(image : Ptr[Image], x : CInt, y : CInt, __return : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetMeshBoundingBox(mesh : Ptr[Mesh], __return : Ptr[BoundingBox]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetModelBoundingBox(model : Ptr[Model], __return : Ptr[BoundingBox]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetMonitorPosition(monitor : CInt, __return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetMouseDelta(__return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetMousePosition(__return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetMouseWheelMoveV(__return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetMusicTimeLength(music : Ptr[Music]): Float = extern

  private[libraylib] def __sn_wrap_libraylib_GetMusicTimePlayed(music : Ptr[Music]): Float = extern

  private[libraylib] def __sn_wrap_libraylib_GetPixelColor(srcPtr : Ptr[Byte], format : CInt, __return : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetRayCollisionBox(ray : Ptr[Ray], box : Ptr[BoundingBox], __return : Ptr[RayCollision]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetRayCollisionMesh(ray : Ptr[Ray], mesh : Ptr[Mesh], transform : Ptr[Matrix], __return : Ptr[RayCollision]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetRayCollisionQuad(ray : Ptr[Ray], p1 : Ptr[Vector3], p2 : Ptr[Vector3], p3 : Ptr[Vector3], p4 : Ptr[Vector3], __return : Ptr[RayCollision]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetRayCollisionSphere(ray : Ptr[Ray], center : Ptr[Vector3], radius : Float, __return : Ptr[RayCollision]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetRayCollisionTriangle(ray : Ptr[Ray], p1 : Ptr[Vector3], p2 : Ptr[Vector3], p3 : Ptr[Vector3], __return : Ptr[RayCollision]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetScreenToWorld2D(position : Ptr[Vector2], camera : Ptr[Camera2D], __return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetScreenToWorldRay(position : Ptr[Vector2], camera : Ptr[Camera], __return : Ptr[Ray]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetScreenToWorldRayEx(position : Ptr[Vector2], camera : Ptr[Camera], width : CInt, height : CInt, __return : Ptr[Ray]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetShaderLocation(shader : Ptr[Shader], uniformName : CString): CInt = extern

  private[libraylib] def __sn_wrap_libraylib_GetShaderLocationAttrib(shader : Ptr[Shader], attribName : CString): CInt = extern

  private[libraylib] def __sn_wrap_libraylib_GetShapesTexture(__return : Ptr[Texture2D]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetShapesTextureRectangle(__return : Ptr[Rectangle]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetSplinePointBasis(p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2], p4 : Ptr[Vector2], t : Float, __return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetSplinePointBezierCubic(p1 : Ptr[Vector2], c2 : Ptr[Vector2], c3 : Ptr[Vector2], p4 : Ptr[Vector2], t : Float, __return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetSplinePointBezierQuad(p1 : Ptr[Vector2], c2 : Ptr[Vector2], p3 : Ptr[Vector2], t : Float, __return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetSplinePointCatmullRom(p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2], p4 : Ptr[Vector2], t : Float, __return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetSplinePointLinear(startPos : Ptr[Vector2], endPos : Ptr[Vector2], t : Float, __return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetTouchPosition(index : CInt, __return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetWindowPosition(__return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetWindowScaleDPI(__return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetWorldToScreen(position : Ptr[Vector3], camera : Ptr[Camera], __return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetWorldToScreen2D(position : Ptr[Vector2], camera : Ptr[Camera2D], __return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_GetWorldToScreenEx(position : Ptr[Vector3], camera : Ptr[Camera], width : CInt, height : CInt, __return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageAlphaClear(image : Ptr[Image], color : Ptr[Color], threshold : Float): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageAlphaMask(image : Ptr[Image], alphaMask : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageClearBackground(dst : Ptr[Image], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageColorReplace(image : Ptr[Image], color : Ptr[Color], replace : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageColorTint(image : Ptr[Image], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageCopy(image : Ptr[Image], __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageCrop(image : Ptr[Image], crop : Ptr[Rectangle]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDraw(dst : Ptr[Image], src : Ptr[Image], srcRec : Ptr[Rectangle], dstRec : Ptr[Rectangle], tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawCircle(dst : Ptr[Image], centerX : CInt, centerY : CInt, radius : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawCircleLines(dst : Ptr[Image], centerX : CInt, centerY : CInt, radius : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawCircleLinesV(dst : Ptr[Image], center : Ptr[Vector2], radius : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawCircleV(dst : Ptr[Image], center : Ptr[Vector2], radius : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawLine(dst : Ptr[Image], startPosX : CInt, startPosY : CInt, endPosX : CInt, endPosY : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawLineEx(dst : Ptr[Image], start : Ptr[Vector2], end : Ptr[Vector2], thick : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawLineV(dst : Ptr[Image], start : Ptr[Vector2], end : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawPixel(dst : Ptr[Image], posX : CInt, posY : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawPixelV(dst : Ptr[Image], position : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawRectangle(dst : Ptr[Image], posX : CInt, posY : CInt, width : CInt, height : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawRectangleLines(dst : Ptr[Image], rec : Ptr[Rectangle], thick : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawRectangleRec(dst : Ptr[Image], rec : Ptr[Rectangle], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawRectangleV(dst : Ptr[Image], position : Ptr[Vector2], size : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawText(dst : Ptr[Image], text : CString, posX : CInt, posY : CInt, fontSize : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawTextEx(dst : Ptr[Image], font : Ptr[Font], text : CString, position : Ptr[Vector2], fontSize : Float, spacing : Float, tint : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawTriangle(dst : Ptr[Image], v1 : Ptr[Vector2], v2 : Ptr[Vector2], v3 : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawTriangleEx(dst : Ptr[Image], v1 : Ptr[Vector2], v2 : Ptr[Vector2], v3 : Ptr[Vector2], c1 : Ptr[Color], c2 : Ptr[Color], c3 : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawTriangleFan(dst : Ptr[Image], points : Ptr[Vector2], pointCount : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawTriangleLines(dst : Ptr[Image], v1 : Ptr[Vector2], v2 : Ptr[Vector2], v3 : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageDrawTriangleStrip(dst : Ptr[Image], points : Ptr[Vector2], pointCount : CInt, color : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageFromChannel(image : Ptr[Image], selectedChannel : CInt, __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageFromImage(image : Ptr[Image], rec : Ptr[Rectangle], __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageResizeCanvas(image : Ptr[Image], newWidth : CInt, newHeight : CInt, offsetX : CInt, offsetY : CInt, fill : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageText(text : CString, fontSize : CInt, color : Ptr[Color], __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageTextEx(font : Ptr[Font], text : CString, fontSize : Float, spacing : Float, tint : Ptr[Color], __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ImageToPOT(image : Ptr[Image], fill : Ptr[Color]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_IsAudioStreamPlaying(stream : Ptr[AudioStream]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsAudioStreamProcessed(stream : Ptr[AudioStream]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsAudioStreamReady(stream : Ptr[AudioStream]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsFontReady(font : Ptr[Font]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsImageReady(image : Ptr[Image]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsMaterialReady(material : Ptr[Material]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsModelAnimationValid(model : Ptr[Model], anim : Ptr[ModelAnimation]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsModelReady(model : Ptr[Model]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsMusicReady(music : Ptr[Music]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsMusicStreamPlaying(music : Ptr[Music]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsRenderTextureReady(target : Ptr[RenderTexture2D]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsShaderReady(shader : Ptr[Shader]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsSoundPlaying(sound : Ptr[Sound]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsSoundReady(sound : Ptr[Sound]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsTextureReady(texture : Ptr[Texture2D]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_IsWaveReady(wave : Ptr[Wave]): Boolean = extern

  private[libraylib] def __sn_wrap_libraylib_LoadAudioStream(sampleRate : CUnsignedInt, sampleSize : CUnsignedInt, channels : CUnsignedInt, __return : Ptr[AudioStream]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadAutomationEventList(fileName : CString, __return : Ptr[AutomationEventList]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadDirectoryFiles(dirPath : CString, __return : Ptr[FilePathList]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadDirectoryFilesEx(basePath : CString, filter : CString, scanSubdirs : Boolean, __return : Ptr[FilePathList]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadDroppedFiles(__return : Ptr[FilePathList]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadFont(fileName : CString, __return : Ptr[Font]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadFontEx(fileName : CString, fontSize : CInt, codepoints : Ptr[CInt], codepointCount : CInt, __return : Ptr[Font]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadFontFromImage(image : Ptr[Image], key : Ptr[Color], firstChar : CInt, __return : Ptr[Font]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadFontFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt, fontSize : CInt, codepoints : Ptr[CInt], codepointCount : CInt, __return : Ptr[Font]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadImage(fileName : CString, __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadImageAnim(fileName : CString, frames : Ptr[CInt], __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadImageAnimFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt, frames : Ptr[CInt], __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadImageColors(image : Ptr[Image]): Ptr[Color] = extern

  private[libraylib] def __sn_wrap_libraylib_LoadImageFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt, __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadImageFromScreen(__return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadImageFromTexture(texture : Ptr[Texture2D], __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadImagePalette(image : Ptr[Image], maxPaletteSize : CInt, colorCount : Ptr[CInt]): Ptr[Color] = extern

  private[libraylib] def __sn_wrap_libraylib_LoadImageRaw(fileName : CString, width : CInt, height : CInt, format : CInt, headerSize : CInt, __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadImageSvg(fileNameOrString : CString, width : CInt, height : CInt, __return : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadMaterialDefault(__return : Ptr[Material]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadModel(fileName : CString, __return : Ptr[Model]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadModelFromMesh(mesh : Ptr[Mesh], __return : Ptr[Model]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadMusicStream(fileName : CString, __return : Ptr[Music]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadMusicStreamFromMemory(fileType : CString, data : Ptr[CUnsignedChar], dataSize : CInt, __return : Ptr[Music]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadRenderTexture(width : CInt, height : CInt, __return : Ptr[RenderTexture2D]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadShader(vsFileName : CString, fsFileName : CString, __return : Ptr[Shader]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadShaderFromMemory(vsCode : CString, fsCode : CString, __return : Ptr[Shader]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadSound(fileName : CString, __return : Ptr[Sound]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadSoundAlias(source : Ptr[Sound], __return : Ptr[Sound]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadSoundFromWave(wave : Ptr[Wave], __return : Ptr[Sound]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadTexture(fileName : CString, __return : Ptr[Texture2D]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadTextureCubemap(image : Ptr[Image], layout : CInt, __return : Ptr[TextureCubemap]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadTextureFromImage(image : Ptr[Image], __return : Ptr[Texture2D]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadVrStereoConfig(device : Ptr[VrDeviceInfo], __return : Ptr[VrStereoConfig]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadWave(fileName : CString, __return : Ptr[Wave]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadWaveFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt, __return : Ptr[Wave]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_LoadWaveSamples(wave : Ptr[Wave]): Ptr[Float] = extern

  private[libraylib] def __sn_wrap_libraylib_MeasureTextEx(font : Ptr[Font], text : CString, fontSize : Float, spacing : Float, __return : Ptr[Vector2]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_PauseAudioStream(stream : Ptr[AudioStream]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_PauseMusicStream(music : Ptr[Music]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_PauseSound(sound : Ptr[Sound]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_PlayAudioStream(stream : Ptr[AudioStream]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_PlayAutomationEvent(event : Ptr[AutomationEvent]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_PlayMusicStream(music : Ptr[Music]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_PlaySound(sound : Ptr[Sound]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ResumeAudioStream(stream : Ptr[AudioStream]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ResumeMusicStream(music : Ptr[Music]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_ResumeSound(sound : Ptr[Sound]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SeekMusicStream(music : Ptr[Music], position : Float): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetAudioStreamCallback(stream : Ptr[AudioStream], callback : AudioCallback): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetAudioStreamPan(stream : Ptr[AudioStream], pan : Float): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetAudioStreamPitch(stream : Ptr[AudioStream], pitch : Float): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetAudioStreamVolume(stream : Ptr[AudioStream], volume : Float): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetMaterialTexture(material : Ptr[Material], mapType : CInt, texture : Ptr[Texture2D]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetMusicPan(music : Ptr[Music], pan : Float): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetMusicPitch(music : Ptr[Music], pitch : Float): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetMusicVolume(music : Ptr[Music], volume : Float): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetPixelColor(dstPtr : Ptr[Byte], color : Ptr[Color], format : CInt): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetShaderValue(shader : Ptr[Shader], locIndex : CInt, value : Ptr[Byte], uniformType : CInt): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetShaderValueMatrix(shader : Ptr[Shader], locIndex : CInt, mat : Ptr[Matrix]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetShaderValueTexture(shader : Ptr[Shader], locIndex : CInt, texture : Ptr[Texture2D]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetShaderValueV(shader : Ptr[Shader], locIndex : CInt, value : Ptr[Byte], uniformType : CInt, count : CInt): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetShapesTexture(texture : Ptr[Texture2D], source : Ptr[Rectangle]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetSoundPan(sound : Ptr[Sound], pan : Float): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetSoundPitch(sound : Ptr[Sound], pitch : Float): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetSoundVolume(sound : Ptr[Sound], volume : Float): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetTextureFilter(texture : Ptr[Texture2D], filter : CInt): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetTextureWrap(texture : Ptr[Texture2D], wrap : CInt): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_SetWindowIcon(image : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_StopAudioStream(stream : Ptr[AudioStream]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_StopMusicStream(music : Ptr[Music]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_StopSound(sound : Ptr[Sound]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadAudioStream(stream : Ptr[AudioStream]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadAutomationEventList(list : Ptr[AutomationEventList]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadDirectoryFiles(files : Ptr[FilePathList]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadDroppedFiles(files : Ptr[FilePathList]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadFont(font : Ptr[Font]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadImage(image : Ptr[Image]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadMaterial(material : Ptr[Material]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadMesh(mesh : Ptr[Mesh]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadModel(model : Ptr[Model]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadModelAnimation(anim : Ptr[ModelAnimation]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadMusicStream(music : Ptr[Music]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadRenderTexture(target : Ptr[RenderTexture2D]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadShader(shader : Ptr[Shader]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadSound(sound : Ptr[Sound]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadSoundAlias(alias : Ptr[Sound]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadTexture(texture : Ptr[Texture2D]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadVrStereoConfig(config : Ptr[VrStereoConfig]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UnloadWave(wave : Ptr[Wave]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UpdateAudioStream(stream : Ptr[AudioStream], data : Ptr[Byte], frameCount : CInt): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UpdateCameraPro(camera : Ptr[Camera], movement : Ptr[Vector3], rotation : Ptr[Vector3], zoom : Float): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UpdateMeshBuffer(mesh : Ptr[Mesh], index : CInt, data : Ptr[Byte], dataSize : CInt, offset : CInt): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UpdateModelAnimation(model : Ptr[Model], anim : Ptr[ModelAnimation], frame : CInt): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UpdateMusicStream(music : Ptr[Music]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UpdateSound(sound : Ptr[Sound], data : Ptr[Byte], sampleCount : CInt): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UpdateTexture(texture : Ptr[Texture2D], pixels : Ptr[Byte]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_UpdateTextureRec(texture : Ptr[Texture2D], rec : Ptr[Rectangle], pixels : Ptr[Byte]): Unit = extern

  private[libraylib] def __sn_wrap_libraylib_WaveCopy(wave : Ptr[Wave], __return : Ptr[Wave]): Unit = extern
...
object functions:
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def AttachAudioStreamProcessor(stream : AudioStream, processor : AudioCallback)(using Zone): Unit = 
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def AttachAudioStreamProcessor(stream : Ptr[AudioStream], processor : AudioCallback): Unit = 
  ...
  */
  def CheckCollisionBoxSphere(box : BoundingBox, center : Vector3, radius : Float)(using Zone): Boolean = 
    ...
    !(__ptr_1 + 0) = box
    !(__ptr_0 + 0) = center
    __sn_wrap_libraylib_CheckCollisionBoxSphere((__ptr_1 + 0), (__ptr_0 + 0), radius)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def CheckCollisionBoxSphere(box : Ptr[BoundingBox], center : Ptr[Vector3], radius : Float): Boolean = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def CheckCollisionBoxes(box1 : Ptr[BoundingBox], box2 : Ptr[BoundingBox]): Boolean = 
    __sn_wrap_libraylib_CheckCollisionBoxes(box1, box2)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def CheckCollisionCircleLine(center : Ptr[Vector2], radius : Float, p1 : Ptr[Vector2], p2 : Ptr[Vector2]): Boolean = 
    __sn_wrap_libraylib_CheckCollisionCircleLine(center, radius, p1, p2)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def CheckCollisionCircleLine(center : Vector2, radius : Float, p1 : Vector2, p2 : Vector2)(using Zone): Boolean = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](3)
    !(__ptr_0 + 0) = center
    !(__ptr_0 + 1) = p1
    !(__ptr_0 + 2) = p2
    __sn_wrap_libraylib_CheckCollisionCircleLine((__ptr_0 + 0), radius, (__ptr_0 + 1), (__ptr_0 + 2))
  ...
  */
  def CheckCollisionCircleRec(center : Vector2, radius : Float, rec : Rectangle)(using Zone): Boolean = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = rec
    __sn_wrap_libraylib_CheckCollisionCircleRec((__ptr_1 + 0), radius, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def CheckCollisionCircleRec(center : Ptr[Vector2], radius : Float, rec : Ptr[Rectangle]): Boolean = 
  ...
  */
  def CheckCollisionCircles(center1 : Vector2, radius1 : Float, center2 : Vector2, radius2 : Float)(using Zone): Boolean = 
    ...
    !(__ptr_0 + 0) = center1
    !(__ptr_0 + 1) = center2
    __sn_wrap_libraylib_CheckCollisionCircles((__ptr_0 + 0), radius1, (__ptr_0 + 1), radius2)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def CheckCollisionCircles(center1 : Ptr[Vector2], radius1 : Float, center2 : Ptr[Vector2], radius2 : Float): Boolean = 
    __sn_wrap_libraylib_CheckCollisionCircles(center1, radius1, center2, radius2)
  ...
  */
  def CheckCollisionLines(startPos1 : Vector2, endPos1 : Vector2, startPos2 : Vector2, endPos2 : Vector2, collisionPoint : Ptr[Vector2])(using Zone): Boolean = 
    ...
    !(__ptr_0 + 2) = startPos2
    !(__ptr_0 + 3) = endPos2
    __sn_wrap_libraylib_CheckCollisionLines((__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2), (__ptr_0 + 3), collisionPoint)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def CheckCollisionLines(startPos1 : Ptr[Vector2], endPos1 : Ptr[Vector2], startPos2 : Ptr[Vector2], endPos2 : Ptr[Vector2], collisionPoint : Ptr[Vector2]): Boolean = 
    __sn_wrap_libraylib_CheckCollisionLines(startPos1, endPos1, startPos2, endPos2, collisionPoint)
  ...
  */
  def CheckCollisionPointCircle(point : Vector2, center : Vector2, radius : Float)(using Zone): Boolean = 
    ...
    !(__ptr_0 + 0) = point
    !(__ptr_0 + 1) = center
    __sn_wrap_libraylib_CheckCollisionPointCircle((__ptr_0 + 0), (__ptr_0 + 1), radius)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def CheckCollisionPointCircle(point : Ptr[Vector2], center : Ptr[Vector2], radius : Float): Boolean = 
  ...
  */
  def CheckCollisionPointLine(point : Vector2, p1 : Vector2, p2 : Vector2, threshold : CInt)(using Zone): Boolean = 
    ...
    !(__ptr_0 + 1) = p1
    !(__ptr_0 + 2) = p2
    __sn_wrap_libraylib_CheckCollisionPointLine((__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2), threshold)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def CheckCollisionPointLine(point : Ptr[Vector2], p1 : Ptr[Vector2], p2 : Ptr[Vector2], threshold : CInt): Boolean = 
    __sn_wrap_libraylib_CheckCollisionPointLine(point, p1, p2, threshold)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def CheckCollisionPointPoly(point : Ptr[Vector2], points : Ptr[Vector2], pointCount : CInt): Boolean = 
    __sn_wrap_libraylib_CheckCollisionPointPoly(point, points, pointCount)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def CheckCollisionPointPoly(point : Vector2, points : Ptr[Vector2], pointCount : CInt)(using Zone): Boolean = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](1)
    !(__ptr_0 + 0) = point
    __sn_wrap_libraylib_CheckCollisionPointPoly((__ptr_0 + 0), points, pointCount)
  ...
  */
  def CheckCollisionPointTriangle(point : Vector2, p1 : Vector2, p2 : Vector2, p3 : Vector2)(using Zone): Boolean = 
    ...
    !(__ptr_0 + 2) = p2
    !(__ptr_0 + 3) = p3
    __sn_wrap_libraylib_CheckCollisionPointTriangle((__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2), (__ptr_0 + 3))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def CheckCollisionPointTriangle(point : Ptr[Vector2], p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2]): Boolean = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def CheckCollisionSpheres(center1 : Ptr[Vector3], radius1 : Float, center2 : Ptr[Vector3], radius2 : Float): Boolean = 
    __sn_wrap_libraylib_CheckCollisionSpheres(center1, radius1, center2, radius2)
  ...
  */
  def CheckCollisionSpheres(center1 : Vector3, radius1 : Float, center2 : Vector3, radius2 : Float)(using Zone): Boolean = 
    ...
    !(__ptr_0 + 0) = center1
    !(__ptr_0 + 1) = center2
    __sn_wrap_libraylib_CheckCollisionSpheres((__ptr_0 + 0), radius1, (__ptr_0 + 1), radius2)
  ...
  */
  def ColorAlphaBlend(dst : Color, src : Color, tint : Color)(using Zone): Color = 
    ...
    !(__ptr_0 + 1) = src
    !(__ptr_0 + 2) = tint
    __sn_wrap_libraylib_ColorAlphaBlend((__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2), (__ptr_0 + 3))
    !(__ptr_0 + 3)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ColorAlphaBlend(dst : Ptr[Color], src : Ptr[Color], tint : Ptr[Color])(__return : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ColorAlphaBlend(dst, src, tint, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ColorAlphaBlend(dst : Ptr[Color], src : Ptr[Color], tint : Ptr[Color])(using Zone): Color = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ColorBrightness(color : Ptr[Color], factor : Float)(__return : Ptr[Color]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ColorContrast(color : Ptr[Color], contrast : Float)(__return : Ptr[Color]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ColorFromHSV(hue : Float, saturation : Float, value : Float)(__return : Ptr[Color]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DetachAudioStreamProcessor(stream : Ptr[AudioStream], processor : AudioCallback): Unit = 
    __sn_wrap_libraylib_DetachAudioStreamProcessor(stream, processor)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DetachAudioStreamProcessor(stream : AudioStream, processor : AudioCallback)(using Zone): Unit = 
    val __ptr_0: Ptr[AudioStream] = alloc[AudioStream](1)
    !(__ptr_0 + 0) = stream
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawBillboard(camera : Camera, texture : Texture2D, position : Vector3, scale : Float, tint : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    ...
    !(__ptr_2 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawBillboard((__ptr_1 + 0), (__ptr_3 + 0), (__ptr_2 + 0), scale, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawBillboard(camera : Ptr[Camera], texture : Ptr[Texture2D], position : Ptr[Vector3], scale : Float, tint : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawBillboard(camera, texture, position, scale, tint)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawBillboardPro(camera : Ptr[Camera], texture : Ptr[Texture2D], source : Ptr[Rectangle], position : Ptr[Vector3], up : Ptr[Vector3], size : Ptr[Vector2], origin : Ptr[Vector2], rotation : Float, tint : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawBillboardPro(camera, texture, source, position, up, size, origin, rotation, tint)
  ...
  */
  def DrawBillboardPro(camera : Camera, texture : Texture2D, source : Rectangle, position : Vector3, up : Vector3, size : Vector2, origin : Vector2, rotation : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_5 + 1) = origin
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawBillboardPro((__ptr_2 + 0), (__ptr_1 + 0), (__ptr_4 + 0), (__ptr_3 + 0), (__ptr_3 + 1), (__ptr_5 + 0), (__ptr_5 + 1), rotation, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawBillboardRec(camera : Ptr[Camera], texture : Ptr[Texture2D], source : Ptr[Rectangle], position : Ptr[Vector3], size : Ptr[Vector2], tint : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawBillboardRec(camera, texture, source, position, size, tint)
  ...
  */
  def DrawBillboardRec(camera : Camera, texture : Texture2D, source : Rectangle, position : Vector3, size : Vector2, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_5 + 0) = size
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawBillboardRec((__ptr_2 + 0), (__ptr_1 + 0), (__ptr_4 + 0), (__ptr_3 + 0), (__ptr_5 + 0), (__ptr_0 + 0))
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCapsule(startPos : Ptr[Vector3], endPos : Ptr[Vector3], radius : Float, slices : CInt, rings : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawCapsule(startPos, endPos, radius, slices, rings, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCapsule(startPos : Vector3, endPos : Vector3, radius : Float, slices : CInt, rings : CInt, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    val __ptr_1: Ptr[Vector3] = alloc[Vector3](2)
    !(__ptr_1 + 0) = startPos
    !(__ptr_1 + 1) = endPos
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawCapsule((__ptr_1 + 0), (__ptr_1 + 1), radius, slices, rings, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCapsuleWires(startPos : Vector3, endPos : Vector3, radius : Float, slices : CInt, rings : CInt, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    val __ptr_1: Ptr[Vector3] = alloc[Vector3](2)
    !(__ptr_1 + 0) = startPos
    !(__ptr_1 + 1) = endPos
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawCapsuleWires((__ptr_1 + 0), (__ptr_1 + 1), radius, slices, rings, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCapsuleWires(startPos : Ptr[Vector3], endPos : Ptr[Vector3], radius : Float, slices : CInt, rings : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawCapsuleWires(startPos, endPos, radius, slices, rings, color)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCircle(centerX : CInt, centerY : CInt, radius : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawCircle(centerX, centerY, radius, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCircle3D(center : Ptr[Vector3], radius : Float, rotationAxis : Ptr[Vector3], rotationAngle : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawCircle3D(center, radius, rotationAxis, rotationAngle, color)
  ...
  */
  def DrawCircle3D(center : Vector3, radius : Float, rotationAxis : Vector3, rotationAngle : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawCircle3D((__ptr_1 + 0), radius, (__ptr_1 + 1), rotationAngle, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCircleGradient(centerX : CInt, centerY : CInt, radius : Float, inner : Ptr[Color], outer : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawCircleGradient(centerX, centerY, radius, inner, outer)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCircleGradient(centerX : CInt, centerY : CInt, radius : Float, inner : Color, outer : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](2)
    !(__ptr_0 + 0) = inner
    !(__ptr_0 + 1) = outer
    __sn_wrap_libraylib_DrawCircleGradient(centerX, centerY, radius, (__ptr_0 + 0), (__ptr_0 + 1))
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCircleLines(centerX : CInt, centerY : CInt, radius : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawCircleLines(centerX, centerY, radius, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCircleLinesV(center : Ptr[Vector2], radius : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawCircleLinesV(center, radius, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCircleLinesV(center : Vector2, radius : Float, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    val __ptr_1: Ptr[Vector2] = alloc[Vector2](1)
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCircleSector(center : Ptr[Vector2], radius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawCircleSector(center, radius, startAngle, endAngle, segments, color)
  ...
  */
  def DrawCircleSector(center : Vector2, radius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawCircleSector((__ptr_1 + 0), radius, startAngle, endAngle, segments, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCircleSectorLines(center : Ptr[Vector2], radius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawCircleSectorLines(center, radius, startAngle, endAngle, segments, color)
  ...
  */
  def DrawCircleSectorLines(center : Vector2, radius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawCircleSectorLines((__ptr_1 + 0), radius, startAngle, endAngle, segments, (__ptr_0 + 0))
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCube(position : Ptr[Vector3], width : Float, height : Float, length : Float, color : Ptr[Color]): Unit = 
  ...
  */
  def DrawCube(position : Vector3, width : Float, height : Float, length : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawCube((__ptr_1 + 0), width, height, length, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCubeV(position : Ptr[Vector3], size : Ptr[Vector3], color : Ptr[Color]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCubeWires(position : Ptr[Vector3], width : Float, height : Float, length : Float, color : Ptr[Color]): Unit = 
  ...
  */
  def DrawCubeWires(position : Vector3, width : Float, height : Float, length : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawCubeWires((__ptr_1 + 0), width, height, length, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCubeWiresV(position : Ptr[Vector3], size : Ptr[Vector3], color : Ptr[Color]): Unit = 
  ...
  */
  def DrawCubeWiresV(position : Vector3, size : Vector3, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = size
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawCubeWiresV((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_0 + 0))
  ...
  */
  def DrawCylinder(position : Vector3, radiusTop : Float, radiusBottom : Float, height : Float, slices : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawCylinder((__ptr_1 + 0), radiusTop, radiusBottom, height, slices, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCylinder(position : Ptr[Vector3], radiusTop : Float, radiusBottom : Float, height : Float, slices : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawCylinder(position, radiusTop, radiusBottom, height, slices, color)
  ...
  */
  def DrawCylinderEx(startPos : Vector3, endPos : Vector3, startRadius : Float, endRadius : Float, sides : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = endPos
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawCylinderEx((__ptr_1 + 0), (__ptr_1 + 1), startRadius, endRadius, sides, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCylinderEx(startPos : Ptr[Vector3], endPos : Ptr[Vector3], startRadius : Float, endRadius : Float, sides : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawCylinderEx(startPos, endPos, startRadius, endRadius, sides, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCylinderWires(position : Ptr[Vector3], radiusTop : Float, radiusBottom : Float, height : Float, slices : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawCylinderWires(position, radiusTop, radiusBottom, height, slices, color)
  ...
  */
  def DrawCylinderWires(position : Vector3, radiusTop : Float, radiusBottom : Float, height : Float, slices : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawCylinderWires((__ptr_1 + 0), radiusTop, radiusBottom, height, slices, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawCylinderWiresEx(startPos : Ptr[Vector3], endPos : Ptr[Vector3], startRadius : Float, endRadius : Float, sides : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawCylinderWiresEx(startPos, endPos, startRadius, endRadius, sides, color)
  ...
  */
  def DrawCylinderWiresEx(startPos : Vector3, endPos : Vector3, startRadius : Float, endRadius : Float, sides : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = endPos
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawCylinderWiresEx((__ptr_1 + 0), (__ptr_1 + 1), startRadius, endRadius, sides, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawEllipse(centerX : CInt, centerY : CInt, radiusH : Float, radiusV : Float, color : Ptr[Color]): Unit = 
  ...
  */
  def DrawEllipse(centerX : CInt, centerY : CInt, radiusH : Float, radiusV : Float, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawEllipse(centerX, centerY, radiusH, radiusV, (__ptr_0 + 0))
  ...
  */
  def DrawEllipseLines(centerX : CInt, centerY : CInt, radiusH : Float, radiusV : Float, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawEllipseLines(centerX, centerY, radiusH, radiusV, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawEllipseLines(centerX : CInt, centerY : CInt, radiusH : Float, radiusV : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawEllipseLines(centerX, centerY, radiusH, radiusV, color)
  ...
  */
  def DrawLine(startPosX : CInt, startPosY : CInt, endPosX : CInt, endPosY : CInt, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawLine(startPosX, startPosY, endPosX, endPosY, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawLine(startPosX : CInt, startPosY : CInt, endPosX : CInt, endPosY : CInt, color : Ptr[Color]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawLine3D(startPos : Ptr[Vector3], endPos : Ptr[Vector3], color : Ptr[Color]): Unit = 
  ...
  */
  def DrawLineBezier(startPos : Vector2, endPos : Vector2, thick : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = endPos
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawLineBezier((__ptr_1 + 0), (__ptr_1 + 1), thick, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawLineBezier(startPos : Ptr[Vector2], endPos : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = 
  ...
  */
  def DrawLineEx(startPos : Vector2, endPos : Vector2, thick : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = endPos
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawLineEx((__ptr_1 + 0), (__ptr_1 + 1), thick, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawLineEx(startPos : Ptr[Vector2], endPos : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawLineEx(startPos, endPos, thick, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawLineStrip(points : Ptr[Vector2], pointCount : CInt, color : Ptr[Color]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawLineV(startPos : Ptr[Vector2], endPos : Ptr[Vector2], color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawLineV(startPos, endPos, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawMesh(mesh : Ptr[Mesh], material : Ptr[Material], transform : Ptr[Matrix]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawMeshInstanced(mesh : Ptr[Mesh], material : Ptr[Material], transforms : Ptr[Matrix], instances : CInt): Unit = 
  ...
  */
  def DrawMeshInstanced(mesh : Mesh, material : Material, transforms : Ptr[Matrix], instances : CInt)(using Zone): Unit = 
    ...
    !(__ptr_0 + 0) = mesh
    !(__ptr_1 + 0) = material
    __sn_wrap_libraylib_DrawMeshInstanced((__ptr_0 + 0), (__ptr_1 + 0), transforms, instances)
  ...
  */
  def DrawModel(model : Model, position : Vector3, scale : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawModel((__ptr_2 + 0), (__ptr_1 + 0), scale, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawModel(model : Ptr[Model], position : Ptr[Vector3], scale : Float, tint : Ptr[Color]): Unit = 
  ...
  */
  def DrawModelEx(model : Model, position : Vector3, rotationAxis : Vector3, rotationAngle : Float, scale : Vector3, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 2) = scale
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawModelEx((__ptr_2 + 0), (__ptr_1 + 0), (__ptr_1 + 1), rotationAngle, (__ptr_1 + 2), (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawModelEx(model : Ptr[Model], position : Ptr[Vector3], rotationAxis : Ptr[Vector3], rotationAngle : Float, scale : Ptr[Vector3], tint : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawModelEx(model, position, rotationAxis, rotationAngle, scale, tint)
  ...
  */
  def DrawModelWires(model : Model, position : Vector3, scale : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawModelWires((__ptr_2 + 0), (__ptr_1 + 0), scale, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawModelWires(model : Ptr[Model], position : Ptr[Vector3], scale : Float, tint : Ptr[Color]): Unit = 
  ...
  */
  def DrawModelWiresEx(model : Model, position : Vector3, rotationAxis : Vector3, rotationAngle : Float, scale : Vector3, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 2) = scale
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawModelWiresEx((__ptr_2 + 0), (__ptr_1 + 0), (__ptr_1 + 1), rotationAngle, (__ptr_1 + 2), (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawModelWiresEx(model : Ptr[Model], position : Ptr[Vector3], rotationAxis : Ptr[Vector3], rotationAngle : Float, scale : Ptr[Vector3], tint : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawModelWiresEx(model, position, rotationAxis, rotationAngle, scale, tint)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawPlane(centerPos : Ptr[Vector3], size : Ptr[Vector2], color : Ptr[Color]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawPoly(center : Ptr[Vector2], sides : CInt, radius : Float, rotation : Float, color : Ptr[Color]): Unit = 
  ...
  */
  def DrawPoly(center : Vector2, sides : CInt, radius : Float, rotation : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawPoly((__ptr_1 + 0), sides, radius, rotation, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawPolyLines(center : Ptr[Vector2], sides : CInt, radius : Float, rotation : Float, color : Ptr[Color]): Unit = 
  ...
  */
  def DrawPolyLines(center : Vector2, sides : CInt, radius : Float, rotation : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawPolyLines((__ptr_1 + 0), sides, radius, rotation, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawPolyLinesEx(center : Ptr[Vector2], sides : CInt, radius : Float, rotation : Float, lineThick : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawPolyLinesEx(center, sides, radius, rotation, lineThick, color)
  ...
  */
  def DrawPolyLinesEx(center : Vector2, sides : CInt, radius : Float, rotation : Float, lineThick : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawPolyLinesEx((__ptr_1 + 0), sides, radius, rotation, lineThick, (__ptr_0 + 0))
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangle(posX : CInt, posY : CInt, width : CInt, height : CInt, color : Ptr[Color]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangleGradientEx(rec : Ptr[Rectangle], topLeft : Ptr[Color], bottomLeft : Ptr[Color], topRight : Ptr[Color], bottomRight : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawRectangleGradientEx(rec, topLeft, bottomLeft, topRight, bottomRight)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangleGradientEx(rec : Rectangle, topLeft : Color, bottomLeft : Color, topRight : Color, bottomRight : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](4)
    ...
    __sn_wrap_libraylib_DrawRectangleGradientEx((__ptr_1 + 0), (__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2), (__ptr_0 + 3))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangleGradientH(posX : CInt, posY : CInt, width : CInt, height : CInt, left : Ptr[Color], right : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawRectangleGradientH(posX, posY, width, height, left, right)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangleGradientH(posX : CInt, posY : CInt, width : CInt, height : CInt, left : Color, right : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](2)
    !(__ptr_0 + 0) = left
    !(__ptr_0 + 1) = right
    __sn_wrap_libraylib_DrawRectangleGradientH(posX, posY, width, height, (__ptr_0 + 0), (__ptr_0 + 1))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangleGradientV(posX : CInt, posY : CInt, width : CInt, height : CInt, top : Color, bottom : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](2)
    !(__ptr_0 + 0) = top
    !(__ptr_0 + 1) = bottom
    __sn_wrap_libraylib_DrawRectangleGradientV(posX, posY, width, height, (__ptr_0 + 0), (__ptr_0 + 1))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangleGradientV(posX : CInt, posY : CInt, width : CInt, height : CInt, top : Ptr[Color], bottom : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawRectangleGradientV(posX, posY, width, height, top, bottom)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangleLines(posX : CInt, posY : CInt, width : CInt, height : CInt, color : Ptr[Color]): Unit = 
  ...
  */
  def DrawRectangleLines(posX : CInt, posY : CInt, width : CInt, height : CInt, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawRectangleLines(posX, posY, width, height, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangleLinesEx(rec : Ptr[Rectangle], lineThick : Float, color : Ptr[Color]): Unit = 
  ...
  */
  def DrawRectangleLinesEx(rec : Rectangle, lineThick : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = rec
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawRectangleLinesEx((__ptr_1 + 0), lineThick, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectanglePro(rec : Ptr[Rectangle], origin : Ptr[Vector2], rotation : Float, color : Ptr[Color]): Unit = 
  ...
  */
  def DrawRectanglePro(rec : Rectangle, origin : Vector2, rotation : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_2 + 0) = origin
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawRectanglePro((__ptr_1 + 0), (__ptr_2 + 0), rotation, (__ptr_0 + 0))
  ...
  */
  def DrawRectangleRounded(rec : Rectangle, roundness : Float, segments : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = rec
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawRectangleRounded((__ptr_1 + 0), roundness, segments, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangleRounded(rec : Ptr[Rectangle], roundness : Float, segments : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawRectangleRounded(rec, roundness, segments, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangleRoundedLines(rec : Ptr[Rectangle], roundness : Float, segments : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawRectangleRoundedLines(rec, roundness, segments, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangleRoundedLines(rec : Rectangle, roundness : Float, segments : CInt, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    val __ptr_1: Ptr[Rectangle] = alloc[Rectangle](1)
    !(__ptr_1 + 0) = rec
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawRectangleRoundedLines((__ptr_1 + 0), roundness, segments, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangleRoundedLinesEx(rec : Rectangle, roundness : Float, segments : CInt, lineThick : Float, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    val __ptr_1: Ptr[Rectangle] = alloc[Rectangle](1)
    !(__ptr_1 + 0) = rec
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawRectangleRoundedLinesEx((__ptr_1 + 0), roundness, segments, lineThick, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangleRoundedLinesEx(rec : Ptr[Rectangle], roundness : Float, segments : CInt, lineThick : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawRectangleRoundedLinesEx(rec, roundness, segments, lineThick, color)
  ...
  */
  def DrawRectangleV(position : Vector2, size : Vector2, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = size
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawRectangleV((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRectangleV(position : Ptr[Vector2], size : Ptr[Vector2], color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawRectangleV(position, size, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRing(center : Ptr[Vector2], innerRadius : Float, outerRadius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawRing(center, innerRadius, outerRadius, startAngle, endAngle, segments, color)
  ...
  */
  def DrawRing(center : Vector2, innerRadius : Float, outerRadius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawRing((__ptr_1 + 0), innerRadius, outerRadius, startAngle, endAngle, segments, (__ptr_0 + 0))
  ...
  */
  def DrawRingLines(center : Vector2, innerRadius : Float, outerRadius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawRingLines((__ptr_1 + 0), innerRadius, outerRadius, startAngle, endAngle, segments, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawRingLines(center : Ptr[Vector2], innerRadius : Float, outerRadius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawRingLines(center, innerRadius, outerRadius, startAngle, endAngle, segments, color)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSphere(centerPos : Ptr[Vector3], radius : Float, color : Ptr[Color]): Unit = 
  ...
  */
  def DrawSphereEx(centerPos : Vector3, radius : Float, rings : CInt, slices : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = centerPos
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawSphereEx((__ptr_1 + 0), radius, rings, slices, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSphereEx(centerPos : Ptr[Vector3], radius : Float, rings : CInt, slices : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawSphereEx(centerPos, radius, rings, slices, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSphereWires(centerPos : Ptr[Vector3], radius : Float, rings : CInt, slices : CInt, color : Ptr[Color]): Unit = 
  ...
  */
  def DrawSphereWires(centerPos : Vector3, radius : Float, rings : CInt, slices : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = centerPos
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawSphereWires((__ptr_1 + 0), radius, rings, slices, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineBasis(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawSplineBasis(points, pointCount, thick, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineBasis(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawSplineBasis(points, pointCount, thick, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineBezierCubic(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawSplineBezierCubic(points, pointCount, thick, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineBezierCubic(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawSplineBezierCubic(points, pointCount, thick, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineBezierQuadratic(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawSplineBezierQuadratic(points, pointCount, thick, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineBezierQuadratic(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawSplineBezierQuadratic(points, pointCount, thick, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineCatmullRom(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawSplineCatmullRom(points, pointCount, thick, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineCatmullRom(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawSplineCatmullRom(points, pointCount, thick, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineLinear(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawSplineLinear(points, pointCount, thick, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineLinear(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawSplineLinear(points, pointCount, thick, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineSegmentBasis(p1 : Vector2, p2 : Vector2, p3 : Vector2, p4 : Vector2, thick : Float, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    ...
    !(__ptr_1 + 3) = p4
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawSplineSegmentBasis((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_1 + 3), thick, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineSegmentBasis(p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2], p4 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawSplineSegmentBasis(p1, p2, p3, p4, thick, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineSegmentBezierCubic(p1 : Ptr[Vector2], c2 : Ptr[Vector2], c3 : Ptr[Vector2], p4 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawSplineSegmentBezierCubic(p1, c2, c3, p4, thick, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineSegmentBezierCubic(p1 : Vector2, c2 : Vector2, c3 : Vector2, p4 : Vector2, thick : Float, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    val __ptr_1: Ptr[Vector2] = alloc[Vector2](4)
    !(__ptr_1 + 0) = p1
    !(__ptr_1 + 1) = c2
    ...
    !(__ptr_1 + 3) = p4
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawSplineSegmentBezierCubic((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_1 + 3), thick, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineSegmentBezierQuadratic(p1 : Vector2, c2 : Vector2, p3 : Vector2, thick : Float, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    ...
    !(__ptr_1 + 2) = p3
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawSplineSegmentBezierQuadratic((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), thick, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineSegmentBezierQuadratic(p1 : Ptr[Vector2], c2 : Ptr[Vector2], p3 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawSplineSegmentBezierQuadratic(p1, c2, p3, thick, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineSegmentCatmullRom(p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2], p4 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawSplineSegmentCatmullRom(p1, p2, p3, p4, thick, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineSegmentCatmullRom(p1 : Vector2, p2 : Vector2, p3 : Vector2, p4 : Vector2, thick : Float, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    val __ptr_1: Ptr[Vector2] = alloc[Vector2](4)
    !(__ptr_1 + 0) = p1
    !(__ptr_1 + 1) = p2
    ...
    !(__ptr_1 + 3) = p4
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawSplineSegmentCatmullRom((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_1 + 3), thick, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineSegmentLinear(p1 : Vector2, p2 : Vector2, thick : Float, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    val __ptr_1: Ptr[Vector2] = alloc[Vector2](2)
    !(__ptr_1 + 0) = p1
    !(__ptr_1 + 1) = p2
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawSplineSegmentLinear((__ptr_1 + 0), (__ptr_1 + 1), thick, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawSplineSegmentLinear(p1 : Ptr[Vector2], p2 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawText(text : CString, posX : CInt, posY : CInt, fontSize : CInt, color : Ptr[Color]): Unit = 
  ...
  */
  def DrawTextCodepoint(font : Font, codepoint : CInt, position : Vector2, fontSize : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_2 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawTextCodepoint((__ptr_1 + 0), codepoint, (__ptr_2 + 0), fontSize, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTextCodepoint(font : Ptr[Font], codepoint : CInt, position : Ptr[Vector2], fontSize : Float, tint : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawTextCodepoint(font, codepoint, position, fontSize, tint)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTextCodepoints(font : Font, codepoints : Ptr[CInt], codepointCount : CInt, position : Vector2, fontSize : Float, spacing : Float, tint : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    val __ptr_1: Ptr[Font] = alloc[Font](1)
    val __ptr_2: Ptr[Vector2] = alloc[Vector2](1)
    !(__ptr_1 + 0) = font
    !(__ptr_2 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawTextCodepoints((__ptr_1 + 0), codepoints, codepointCount, (__ptr_2 + 0), fontSize, spacing, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTextCodepoints(font : Ptr[Font], codepoints : Ptr[CInt], codepointCount : CInt, position : Ptr[Vector2], fontSize : Float, spacing : Float, tint : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawTextCodepoints(font, codepoints, codepointCount, position, fontSize, spacing, tint)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTextEx(font : Ptr[Font], text : CString, position : Ptr[Vector2], fontSize : Float, spacing : Float, tint : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawTextEx(font, text, position, fontSize, spacing, tint)
  ...
  */
  def DrawTextEx(font : Font, text : CString, position : Vector2, fontSize : Float, spacing : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_2 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawTextEx((__ptr_1 + 0), text, (__ptr_2 + 0), fontSize, spacing, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTextPro(font : Ptr[Font], text : CString, position : Ptr[Vector2], origin : Ptr[Vector2], rotation : Float, fontSize : Float, spacing : Float, tint : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawTextPro(font, text, position, origin, rotation, fontSize, spacing, tint)
  ...
  */
  def DrawTextPro(font : Font, text : CString, position : Vector2, origin : Vector2, rotation : Float, fontSize : Float, spacing : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_2 + 1) = origin
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawTextPro((__ptr_1 + 0), text, (__ptr_2 + 0), (__ptr_2 + 1), rotation, fontSize, spacing, (__ptr_0 + 0))
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTexture(texture : Ptr[Texture2D], posX : CInt, posY : CInt, tint : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawTexture(texture, posX, posY, tint)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTextureEx(texture : Ptr[Texture2D], position : Ptr[Vector2], rotation : Float, scale : Float, tint : Ptr[Color]): Unit = 
  ...
  */
  def DrawTextureEx(texture : Texture2D, position : Vector2, rotation : Float, scale : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_2 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawTextureEx((__ptr_1 + 0), (__ptr_2 + 0), rotation, scale, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTextureNPatch(texture : Ptr[Texture2D], nPatchInfo : Ptr[NPatchInfo], dest : Ptr[Rectangle], origin : Ptr[Vector2], rotation : Float, tint : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawTextureNPatch(texture, nPatchInfo, dest, origin, rotation, tint)
  ...
  */
  def DrawTextureNPatch(texture : Texture2D, nPatchInfo : NPatchInfo, dest : Rectangle, origin : Vector2, rotation : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_4 + 0) = origin
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawTextureNPatch((__ptr_2 + 0), (__ptr_1 + 0), (__ptr_3 + 0), (__ptr_4 + 0), rotation, (__ptr_0 + 0))
  ...
  */
  def DrawTexturePro(texture : Texture2D, source : Rectangle, dest : Rectangle, origin : Vector2, rotation : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_3 + 0) = origin
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawTexturePro((__ptr_1 + 0), (__ptr_2 + 0), (__ptr_2 + 1), (__ptr_3 + 0), rotation, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTexturePro(texture : Ptr[Texture2D], source : Ptr[Rectangle], dest : Ptr[Rectangle], origin : Ptr[Vector2], rotation : Float, tint : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawTexturePro(texture, source, dest, origin, rotation, tint)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTextureRec(texture : Ptr[Texture2D], source : Ptr[Rectangle], position : Ptr[Vector2], tint : Ptr[Color]): Unit = 
  ...
  */
  def DrawTextureRec(texture : Texture2D, source : Rectangle, position : Vector2, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_3 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawTextureRec((__ptr_1 + 0), (__ptr_2 + 0), (__ptr_3 + 0), (__ptr_0 + 0))
  ...
  */
  def DrawTextureV(texture : Texture2D, position : Vector2, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_2 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_DrawTextureV((__ptr_1 + 0), (__ptr_2 + 0), (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTextureV(texture : Ptr[Texture2D], position : Ptr[Vector2], tint : Ptr[Color]): Unit = 
  ...
  */
  def DrawTriangle(v1 : Vector2, v2 : Vector2, v3 : Vector2, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 2) = v3
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawTriangle((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTriangle(v1 : Ptr[Vector2], v2 : Ptr[Vector2], v3 : Ptr[Vector2], color : Ptr[Color]): Unit = 
  ...
  */
  def DrawTriangle3D(v1 : Vector3, v2 : Vector3, v3 : Vector3, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 2) = v3
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawTriangle3D((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTriangle3D(v1 : Ptr[Vector3], v2 : Ptr[Vector3], v3 : Ptr[Vector3], color : Ptr[Color]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTriangleFan(points : Ptr[Vector2], pointCount : CInt, color : Ptr[Color]): Unit = 
  ...
  */
  def DrawTriangleLines(v1 : Vector2, v2 : Vector2, v3 : Vector2, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 2) = v3
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_DrawTriangleLines((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTriangleLines(v1 : Ptr[Vector2], v2 : Ptr[Vector2], v3 : Ptr[Vector2], color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_DrawTriangleLines(v1, v2, v3, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTriangleStrip(points : Ptr[Vector2], pointCount : CInt, color : Ptr[Color]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def DrawTriangleStrip3D(points : Ptr[Vector3], pointCount : CInt, color : Ptr[Color]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ExportAutomationEventList(list : AutomationEventList, fileName : CString)(using Zone): Boolean = 
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ExportAutomationEventList(list : Ptr[AutomationEventList], fileName : CString): Boolean = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ExportImageToMemory(image : Image, fileType : CString, fileSize : Ptr[CInt])(using Zone): Ptr[CUnsignedChar] = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
    !(__ptr_0 + 0) = image
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ExportImageToMemory(image : Ptr[Image], fileType : CString, fileSize : Ptr[CInt]): Ptr[CUnsignedChar] = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageCellular(width : CInt, height : CInt, tileSize : CInt)(__return : Ptr[Image]): Unit = 
  ...
  */
  def GenImageChecked(width : CInt, height : CInt, checksX : CInt, checksY : CInt, col1 : Color, col2 : Color)(using Zone): Image = 
    ...
    !(__ptr_0 + 0) = col1
    !(__ptr_0 + 1) = col2
    __sn_wrap_libraylib_GenImageChecked(width, height, checksX, checksY, (__ptr_0 + 0), (__ptr_0 + 1), (__ptr_1 + 0))
    !(__ptr_1 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageChecked(width : CInt, height : CInt, checksX : CInt, checksY : CInt, col1 : Ptr[Color], col2 : Ptr[Color])(__return : Ptr[Image]): Unit = 
    __sn_wrap_libraylib_GenImageChecked(width, height, checksX, checksY, col1, col2, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageChecked(width : CInt, height : CInt, checksX : CInt, checksY : CInt, col1 : Ptr[Color], col2 : Ptr[Color])(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
    __sn_wrap_libraylib_GenImageChecked(width, height, checksX, checksY, col1, col2, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageColor(width : CInt, height : CInt, color : Ptr[Color])(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageColor(width : CInt, height : CInt, color : Ptr[Color])(__return : Ptr[Image]): Unit = 
  ...
  */
  def GenImageColor(width : CInt, height : CInt, color : Color)(using Zone): Image = 
    ...
    val __ptr_1: Ptr[Image] = alloc[Image](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_GenImageColor(width, height, (__ptr_0 + 0), (__ptr_1 + 0))
    !(__ptr_1 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageFontAtlas(glyphs : Ptr[GlyphInfo], glyphRecs : Ptr[Ptr[Rectangle]], glyphCount : CInt, fontSize : CInt, padding : CInt, packMethod : CInt)(__return : Ptr[Image]): Unit = 
    __sn_wrap_libraylib_GenImageFontAtlas(glyphs, glyphRecs, glyphCount, fontSize, padding, packMethod, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageFontAtlas(glyphs : Ptr[GlyphInfo], glyphRecs : Ptr[Ptr[Rectangle]], glyphCount : CInt, fontSize : CInt, padding : CInt, packMethod : CInt)(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
    __sn_wrap_libraylib_GenImageFontAtlas(glyphs, glyphRecs, glyphCount, fontSize, padding, packMethod, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageGradientLinear(width : CInt, height : CInt, direction : CInt, start : Color, end : Color)(using Zone): Image = 
    val __ptr_0: Ptr[Color] = alloc[Color](2)
    val __ptr_1: Ptr[Image] = alloc[Image](1)
    !(__ptr_0 + 0) = start
    !(__ptr_0 + 1) = end
    __sn_wrap_libraylib_GenImageGradientLinear(width, height, direction, (__ptr_0 + 0), (__ptr_0 + 1), (__ptr_1 + 0))
    !(__ptr_1 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageGradientLinear(width : CInt, height : CInt, direction : CInt, start : Ptr[Color], end : Ptr[Color])(__return : Ptr[Image]): Unit = 
    __sn_wrap_libraylib_GenImageGradientLinear(width, height, direction, start, end, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageGradientLinear(width : CInt, height : CInt, direction : CInt, start : Ptr[Color], end : Ptr[Color])(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
    __sn_wrap_libraylib_GenImageGradientLinear(width, height, direction, start, end, (__ptr_0 + 0))
    !(__ptr_0 + 0)
  ...
  */
  def GenImageGradientRadial(width : CInt, height : CInt, density : Float, inner : Color, outer : Color)(using Zone): Image = 
    ...
    !(__ptr_0 + 0) = inner
    !(__ptr_0 + 1) = outer
    __sn_wrap_libraylib_GenImageGradientRadial(width, height, density, (__ptr_0 + 0), (__ptr_0 + 1), (__ptr_1 + 0))
    !(__ptr_1 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageGradientRadial(width : CInt, height : CInt, density : Float, inner : Ptr[Color], outer : Ptr[Color])(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
    __sn_wrap_libraylib_GenImageGradientRadial(width, height, density, inner, outer, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageGradientRadial(width : CInt, height : CInt, density : Float, inner : Ptr[Color], outer : Ptr[Color])(__return : Ptr[Image]): Unit = 
    __sn_wrap_libraylib_GenImageGradientRadial(width, height, density, inner, outer, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageGradientSquare(width : CInt, height : CInt, density : Float, inner : Ptr[Color], outer : Ptr[Color])(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
    __sn_wrap_libraylib_GenImageGradientSquare(width, height, density, inner, outer, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageGradientSquare(width : CInt, height : CInt, density : Float, inner : Ptr[Color], outer : Ptr[Color])(__return : Ptr[Image]): Unit = 
    __sn_wrap_libraylib_GenImageGradientSquare(width, height, density, inner, outer, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageGradientSquare(width : CInt, height : CInt, density : Float, inner : Color, outer : Color)(using Zone): Image = 
    val __ptr_0: Ptr[Color] = alloc[Color](2)
    val __ptr_1: Ptr[Image] = alloc[Image](1)
    !(__ptr_0 + 0) = inner
    !(__ptr_0 + 1) = outer
    __sn_wrap_libraylib_GenImageGradientSquare(width, height, density, (__ptr_0 + 0), (__ptr_0 + 1), (__ptr_1 + 0))
    !(__ptr_1 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImagePerlinNoise(width : CInt, height : CInt, offsetX : CInt, offsetY : CInt, scale : Float)(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
    __sn_wrap_libraylib_GenImagePerlinNoise(width, height, offsetX, offsetY, scale, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImagePerlinNoise(width : CInt, height : CInt, offsetX : CInt, offsetY : CInt, scale : Float)(__return : Ptr[Image]): Unit = 
    __sn_wrap_libraylib_GenImagePerlinNoise(width, height, offsetX, offsetY, scale, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageText(width : CInt, height : CInt, text : CString)(__return : Ptr[Image]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenImageWhiteNoise(width : CInt, height : CInt, factor : Float)(__return : Ptr[Image]): Unit = 
    __sn_wrap_libraylib_GenImageWhiteNoise(width, height, factor, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenMeshCone(radius : Float, height : Float, slices : CInt)(__return : Ptr[Mesh]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenMeshCube(width : Float, height : Float, length : Float)(__return : Ptr[Mesh]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenMeshCubicmap(cubicmap : Ptr[Image], cubeSize : Ptr[Vector3])(__return : Ptr[Mesh]): Unit = 
    __sn_wrap_libraylib_GenMeshCubicmap(cubicmap, cubeSize, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenMeshCubicmap(cubicmap : Ptr[Image], cubeSize : Ptr[Vector3])(using Zone): Mesh = 
    val __ptr_0: Ptr[Mesh] = alloc[Mesh](1)
  ...
  */
  def GenMeshCubicmap(cubicmap : Image, cubeSize : Vector3)(using Zone): Mesh = 
    ...
    !(__ptr_2 + 0) = cubicmap
    !(__ptr_0 + 0) = cubeSize
    __sn_wrap_libraylib_GenMeshCubicmap((__ptr_2 + 0), (__ptr_0 + 0), (__ptr_1 + 0))
    !(__ptr_1 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenMeshCylinder(radius : Float, height : Float, slices : CInt)(__return : Ptr[Mesh]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenMeshHeightmap(heightmap : Ptr[Image], size : Ptr[Vector3])(using Zone): Mesh = 
    val __ptr_0: Ptr[Mesh] = alloc[Mesh](1)
  ...
  */
  def GenMeshHeightmap(heightmap : Image, size : Vector3)(using Zone): Mesh = 
    ...
    !(__ptr_2 + 0) = heightmap
    !(__ptr_0 + 0) = size
    __sn_wrap_libraylib_GenMeshHeightmap((__ptr_2 + 0), (__ptr_0 + 0), (__ptr_1 + 0))
    !(__ptr_1 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenMeshHeightmap(heightmap : Ptr[Image], size : Ptr[Vector3])(__return : Ptr[Mesh]): Unit = 
    __sn_wrap_libraylib_GenMeshHeightmap(heightmap, size, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenMeshHemiSphere(radius : Float, rings : CInt, slices : CInt)(__return : Ptr[Mesh]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenMeshKnot(radius : Float, size : Float, radSeg : CInt, sides : CInt)(__return : Ptr[Mesh]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenMeshPlane(width : Float, length : Float, resX : CInt, resZ : CInt)(__return : Ptr[Mesh]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenMeshSphere(radius : Float, rings : CInt, slices : CInt)(__return : Ptr[Mesh]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GenMeshTorus(radius : Float, size : Float, radSeg : CInt, sides : CInt)(__return : Ptr[Mesh]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetCollisionRec(rec1 : Ptr[Rectangle], rec2 : Ptr[Rectangle])(__return : Ptr[Rectangle]): Unit = 
    __sn_wrap_libraylib_GetCollisionRec(rec1, rec2, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetCollisionRec(rec1 : Ptr[Rectangle], rec2 : Ptr[Rectangle])(using Zone): Rectangle = 
    val __ptr_0: Ptr[Rectangle] = alloc[Rectangle](1)
  ...
  */
  def GetCollisionRec(rec1 : Rectangle, rec2 : Rectangle)(using Zone): Rectangle = 
    ...
    !(__ptr_0 + 0) = rec1
    !(__ptr_0 + 1) = rec2
    __sn_wrap_libraylib_GetCollisionRec((__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2))
    !(__ptr_0 + 2)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetGlyphAtlasRec(font : Ptr[Font], codepoint : CInt)(__return : Ptr[Rectangle]): Unit = 
  ...
  */
  def GetGlyphAtlasRec(font : Font, codepoint : CInt)(using Zone): Rectangle = 
    ...
    val __ptr_1: Ptr[Rectangle] = alloc[Rectangle](1)
    !(__ptr_0 + 0) = font
    __sn_wrap_libraylib_GetGlyphAtlasRec((__ptr_0 + 0), codepoint, (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetGlyphInfo(font : Ptr[Font], codepoint : CInt)(__return : Ptr[GlyphInfo]): Unit = 
    __sn_wrap_libraylib_GetGlyphInfo(font, codepoint, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetImageAlphaBorder(image : Ptr[Image], threshold : Float)(using Zone): Rectangle = 
    val __ptr_0: Ptr[Rectangle] = alloc[Rectangle](1)
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetImageAlphaBorder(image : Ptr[Image], threshold : Float)(__return : Ptr[Rectangle]): Unit = 
  ...
  */
  def GetImageAlphaBorder(image : Image, threshold : Float)(using Zone): Rectangle = 
    ...
    val __ptr_1: Ptr[Rectangle] = alloc[Rectangle](1)
    !(__ptr_0 + 0) = image
    __sn_wrap_libraylib_GetImageAlphaBorder((__ptr_0 + 0), threshold, (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetImageColor(image : Ptr[Image], x : CInt, y : CInt)(__return : Ptr[Color]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetRayCollisionBox(ray : Ptr[Ray], box : Ptr[BoundingBox])(__return : Ptr[RayCollision]): Unit = 
    __sn_wrap_libraylib_GetRayCollisionBox(ray, box, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetRayCollisionBox(ray : Ptr[Ray], box : Ptr[BoundingBox])(using Zone): RayCollision = 
  ...
  */
  def GetRayCollisionBox(ray : Ray, box : BoundingBox)(using Zone): RayCollision = 
    ...
    !(__ptr_2 + 0) = ray
    !(__ptr_1 + 0) = box
    __sn_wrap_libraylib_GetRayCollisionBox((__ptr_2 + 0), (__ptr_1 + 0), (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetRayCollisionMesh(ray : Ptr[Ray], mesh : Ptr[Mesh], transform : Ptr[Matrix])(using Zone): RayCollision = 
    val __ptr_0: Ptr[RayCollision] = alloc[RayCollision](1)
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetRayCollisionMesh(ray : Ptr[Ray], mesh : Ptr[Mesh], transform : Ptr[Matrix])(__return : Ptr[RayCollision]): Unit = 
  ...
  */
  def GetRayCollisionMesh(ray : Ray, mesh : Mesh, transform : Matrix)(using Zone): RayCollision = 
    ...
    !(__ptr_1 + 0) = mesh
    !(__ptr_0 + 0) = transform
    __sn_wrap_libraylib_GetRayCollisionMesh((__ptr_3 + 0), (__ptr_1 + 0), (__ptr_0 + 0), (__ptr_2 + 0))
    !(__ptr_2 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetRayCollisionQuad(ray : Ptr[Ray], p1 : Ptr[Vector3], p2 : Ptr[Vector3], p3 : Ptr[Vector3], p4 : Ptr[Vector3])(__return : Ptr[RayCollision]): Unit = 
    __sn_wrap_libraylib_GetRayCollisionQuad(ray, p1, p2, p3, p4, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetRayCollisionQuad(ray : Ptr[Ray], p1 : Ptr[Vector3], p2 : Ptr[Vector3], p3 : Ptr[Vector3], p4 : Ptr[Vector3])(using Zone): RayCollision = 
    val __ptr_0: Ptr[RayCollision] = alloc[RayCollision](1)
  ...
  */
  def GetRayCollisionQuad(ray : Ray, p1 : Vector3, p2 : Vector3, p3 : Vector3, p4 : Vector3)(using Zone): RayCollision = 
    ...
    !(__ptr_0 + 2) = p3
    !(__ptr_0 + 3) = p4
    __sn_wrap_libraylib_GetRayCollisionQuad((__ptr_2 + 0), (__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2), (__ptr_0 + 3), (__ptr_1 + 0))
    !(__ptr_1 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetRayCollisionSphere(ray : Ptr[Ray], center : Ptr[Vector3], radius : Float)(__return : Ptr[RayCollision]): Unit = 
    __sn_wrap_libraylib_GetRayCollisionSphere(ray, center, radius, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetRayCollisionSphere(ray : Ptr[Ray], center : Ptr[Vector3], radius : Float)(using Zone): RayCollision = 
    val __ptr_0: Ptr[RayCollision] = alloc[RayCollision](1)
    __sn_wrap_libraylib_GetRayCollisionSphere(ray, center, radius, (__ptr_0 + 0))
    !(__ptr_0 + 0)
  ...
  */
  def GetRayCollisionSphere(ray : Ray, center : Vector3, radius : Float)(using Zone): RayCollision = 
    ...
    !(__ptr_2 + 0) = ray
    !(__ptr_0 + 0) = center
    __sn_wrap_libraylib_GetRayCollisionSphere((__ptr_2 + 0), (__ptr_0 + 0), radius, (__ptr_1 + 0))
    !(__ptr_1 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetRayCollisionTriangle(ray : Ptr[Ray], p1 : Ptr[Vector3], p2 : Ptr[Vector3], p3 : Ptr[Vector3])(using Zone): RayCollision = 
    val __ptr_0: Ptr[RayCollision] = alloc[RayCollision](1)
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetRayCollisionTriangle(ray : Ptr[Ray], p1 : Ptr[Vector3], p2 : Ptr[Vector3], p3 : Ptr[Vector3])(__return : Ptr[RayCollision]): Unit = 
  ...
  */
  def GetRayCollisionTriangle(ray : Ray, p1 : Vector3, p2 : Vector3, p3 : Vector3)(using Zone): RayCollision = 
    ...
    !(__ptr_0 + 1) = p2
    !(__ptr_0 + 2) = p3
    __sn_wrap_libraylib_GetRayCollisionTriangle((__ptr_2 + 0), (__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2), (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  */
  def GetScreenToWorld2D(position : Vector2, camera : Camera2D)(using Zone): Vector2 = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = camera
    __sn_wrap_libraylib_GetScreenToWorld2D((__ptr_1 + 0), (__ptr_0 + 0), (__ptr_1 + 1))
    !(__ptr_1 + 1)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetScreenToWorld2D(position : Ptr[Vector2], camera : Ptr[Camera2D])(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](1)
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetScreenToWorld2D(position : Ptr[Vector2], camera : Ptr[Camera2D])(__return : Ptr[Vector2]): Unit = 
  ...
  */
  def GetScreenToWorldRay(position : Vector2, camera : Camera)(using Zone): Ray = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = camera
    __sn_wrap_libraylib_GetScreenToWorldRay((__ptr_1 + 0), (__ptr_0 + 0), (__ptr_2 + 0))
    !(__ptr_2 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetScreenToWorldRay(position : Ptr[Vector2], camera : Ptr[Camera])(__return : Ptr[Ray]): Unit = 
    __sn_wrap_libraylib_GetScreenToWorldRay(position, camera, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetScreenToWorldRay(position : Ptr[Vector2], camera : Ptr[Camera])(using Zone): Ray = 
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetScreenToWorldRayEx(position : Ptr[Vector2], camera : Ptr[Camera], width : CInt, height : CInt)(using Zone): Ray = 
    val __ptr_0: Ptr[Ray] = alloc[Ray](1)
    __sn_wrap_libraylib_GetScreenToWorldRayEx(position, camera, width, height, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetScreenToWorldRayEx(position : Vector2, camera : Camera, width : CInt, height : CInt)(using Zone): Ray = 
    val __ptr_0: Ptr[Camera] = alloc[Camera](1)
    val __ptr_1: Ptr[Vector2] = alloc[Vector2](1)
    val __ptr_2: Ptr[Ray] = alloc[Ray](1)
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = camera
    __sn_wrap_libraylib_GetScreenToWorldRayEx((__ptr_1 + 0), (__ptr_0 + 0), width, height, (__ptr_2 + 0))
    !(__ptr_2 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetScreenToWorldRayEx(position : Ptr[Vector2], camera : Ptr[Camera], width : CInt, height : CInt)(__return : Ptr[Ray]): Unit = 
    __sn_wrap_libraylib_GetScreenToWorldRayEx(position, camera, width, height, __return)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointBasis(p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2], p4 : Ptr[Vector2], t : Float)(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](1)
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointBasis(p1 : Vector2, p2 : Vector2, p3 : Vector2, p4 : Vector2, t : Float)(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](5)
    !(__ptr_0 + 0) = p1
    !(__ptr_0 + 1) = p2
    !(__ptr_0 + 2) = p3
    !(__ptr_0 + 3) = p4
    __sn_wrap_libraylib_GetSplinePointBasis((__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2), (__ptr_0 + 3), t, (__ptr_0 + 4))
    !(__ptr_0 + 4)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointBasis(p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2], p4 : Ptr[Vector2], t : Float)(__return : Ptr[Vector2]): Unit = 
    __sn_wrap_libraylib_GetSplinePointBasis(p1, p2, p3, p4, t, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointBezierCubic(p1 : Vector2, c2 : Vector2, c3 : Vector2, p4 : Vector2, t : Float)(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](5)
    !(__ptr_0 + 0) = p1
    !(__ptr_0 + 1) = c2
    !(__ptr_0 + 2) = c3
    !(__ptr_0 + 3) = p4
    __sn_wrap_libraylib_GetSplinePointBezierCubic((__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2), (__ptr_0 + 3), t, (__ptr_0 + 4))
    !(__ptr_0 + 4)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointBezierCubic(p1 : Ptr[Vector2], c2 : Ptr[Vector2], c3 : Ptr[Vector2], p4 : Ptr[Vector2], t : Float)(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](1)
    __sn_wrap_libraylib_GetSplinePointBezierCubic(p1, c2, c3, p4, t, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointBezierCubic(p1 : Ptr[Vector2], c2 : Ptr[Vector2], c3 : Ptr[Vector2], p4 : Ptr[Vector2], t : Float)(__return : Ptr[Vector2]): Unit = 
    __sn_wrap_libraylib_GetSplinePointBezierCubic(p1, c2, c3, p4, t, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointBezierQuad(p1 : Ptr[Vector2], c2 : Ptr[Vector2], p3 : Ptr[Vector2], t : Float)(__return : Ptr[Vector2]): Unit = 
    __sn_wrap_libraylib_GetSplinePointBezierQuad(p1, c2, p3, t, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointBezierQuad(p1 : Ptr[Vector2], c2 : Ptr[Vector2], p3 : Ptr[Vector2], t : Float)(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](1)
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointBezierQuad(p1 : Vector2, c2 : Vector2, p3 : Vector2, t : Float)(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](4)
    !(__ptr_0 + 0) = p1
    !(__ptr_0 + 1) = c2
    !(__ptr_0 + 2) = p3
    __sn_wrap_libraylib_GetSplinePointBezierQuad((__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2), t, (__ptr_0 + 3))
    !(__ptr_0 + 3)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointCatmullRom(p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2], p4 : Ptr[Vector2], t : Float)(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](1)
    __sn_wrap_libraylib_GetSplinePointCatmullRom(p1, p2, p3, p4, t, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointCatmullRom(p1 : Vector2, p2 : Vector2, p3 : Vector2, p4 : Vector2, t : Float)(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](5)
    !(__ptr_0 + 0) = p1
    !(__ptr_0 + 1) = p2
    !(__ptr_0 + 2) = p3
    !(__ptr_0 + 3) = p4
    __sn_wrap_libraylib_GetSplinePointCatmullRom((__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2), (__ptr_0 + 3), t, (__ptr_0 + 4))
    !(__ptr_0 + 4)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointCatmullRom(p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2], p4 : Ptr[Vector2], t : Float)(__return : Ptr[Vector2]): Unit = 
    __sn_wrap_libraylib_GetSplinePointCatmullRom(p1, p2, p3, p4, t, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointLinear(startPos : Ptr[Vector2], endPos : Ptr[Vector2], t : Float)(__return : Ptr[Vector2]): Unit = 
    __sn_wrap_libraylib_GetSplinePointLinear(startPos, endPos, t, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointLinear(startPos : Ptr[Vector2], endPos : Ptr[Vector2], t : Float)(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](1)
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetSplinePointLinear(startPos : Vector2, endPos : Vector2, t : Float)(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](3)
    !(__ptr_0 + 0) = startPos
    !(__ptr_0 + 1) = endPos
    __sn_wrap_libraylib_GetSplinePointLinear((__ptr_0 + 0), (__ptr_0 + 1), t, (__ptr_0 + 2))
    !(__ptr_0 + 2)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetWorldToScreen(position : Ptr[Vector3], camera : Ptr[Camera])(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](1)
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetWorldToScreen(position : Ptr[Vector3], camera : Ptr[Camera])(__return : Ptr[Vector2]): Unit = 
  ...
  */
  def GetWorldToScreen(position : Vector3, camera : Camera)(using Zone): Vector2 = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = camera
    __sn_wrap_libraylib_GetWorldToScreen((__ptr_1 + 0), (__ptr_0 + 0), (__ptr_2 + 0))
    !(__ptr_2 + 0)
  ...
  */
  def GetWorldToScreen2D(position : Vector2, camera : Camera2D)(using Zone): Vector2 = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = camera
    __sn_wrap_libraylib_GetWorldToScreen2D((__ptr_1 + 0), (__ptr_0 + 0), (__ptr_1 + 1))
    !(__ptr_1 + 1)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetWorldToScreen2D(position : Ptr[Vector2], camera : Ptr[Camera2D])(__return : Ptr[Vector2]): Unit = 
    __sn_wrap_libraylib_GetWorldToScreen2D(position, camera, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetWorldToScreen2D(position : Ptr[Vector2], camera : Ptr[Camera2D])(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](1)
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetWorldToScreenEx(position : Ptr[Vector3], camera : Ptr[Camera], width : CInt, height : CInt)(__return : Ptr[Vector2]): Unit = 
    __sn_wrap_libraylib_GetWorldToScreenEx(position, camera, width, height, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def GetWorldToScreenEx(position : Ptr[Vector3], camera : Ptr[Camera], width : CInt, height : CInt)(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](1)
    __sn_wrap_libraylib_GetWorldToScreenEx(position, camera, width, height, (__ptr_0 + 0))
    !(__ptr_0 + 0)
  ...
  */
  def GetWorldToScreenEx(position : Vector3, camera : Camera, width : CInt, height : CInt)(using Zone): Vector2 = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = camera
    __sn_wrap_libraylib_GetWorldToScreenEx((__ptr_1 + 0), (__ptr_0 + 0), width, height, (__ptr_2 + 0))
    !(__ptr_2 + 0)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageAlphaClear(image : Ptr[Image], color : Ptr[Color], threshold : Float): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageColorReplace(image : Ptr[Image], color : Ptr[Color], replace : Ptr[Color]): Unit = 
  ...
  */
  def ImageDraw(dst : Ptr[Image], src : Image, srcRec : Rectangle, dstRec : Rectangle, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_2 + 1) = dstRec
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_ImageDraw(dst, (__ptr_1 + 0), (__ptr_2 + 0), (__ptr_2 + 1), (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDraw(dst : Ptr[Image], src : Ptr[Image], srcRec : Ptr[Rectangle], dstRec : Ptr[Rectangle], tint : Ptr[Color]): Unit = 
  ...
  */
  def ImageDrawCircle(dst : Ptr[Image], centerX : CInt, centerY : CInt, radius : CInt, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawCircle(dst, centerX, centerY, radius, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawCircle(dst : Ptr[Image], centerX : CInt, centerY : CInt, radius : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageDrawCircle(dst, centerX, centerY, radius, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawCircleLines(dst : Ptr[Image], centerX : CInt, centerY : CInt, radius : CInt, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawCircleLines(dst, centerX, centerY, radius, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawCircleLines(dst : Ptr[Image], centerX : CInt, centerY : CInt, radius : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageDrawCircleLines(dst, centerX, centerY, radius, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawCircleLinesV(dst : Ptr[Image], center : Ptr[Vector2], radius : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageDrawCircleLinesV(dst, center, radius, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawCircleLinesV(dst : Ptr[Image], center : Vector2, radius : CInt, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    val __ptr_1: Ptr[Vector2] = alloc[Vector2](1)
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawCircleLinesV(dst, (__ptr_1 + 0), radius, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawCircleV(dst : Ptr[Image], center : Ptr[Vector2], radius : CInt, color : Ptr[Color]): Unit = 
  ...
  */
  def ImageDrawCircleV(dst : Ptr[Image], center : Vector2, radius : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawCircleV(dst, (__ptr_1 + 0), radius, (__ptr_0 + 0))
  ...
  */
  def ImageDrawLine(dst : Ptr[Image], startPosX : CInt, startPosY : CInt, endPosX : CInt, endPosY : CInt, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawLine(dst, startPosX, startPosY, endPosX, endPosY, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawLine(dst : Ptr[Image], startPosX : CInt, startPosY : CInt, endPosX : CInt, endPosY : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageDrawLine(dst, startPosX, startPosY, endPosX, endPosY, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawLineEx(dst : Ptr[Image], start : Ptr[Vector2], end : Ptr[Vector2], thick : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageDrawLineEx(dst, start, end, thick, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawLineEx(dst : Ptr[Image], start : Vector2, end : Vector2, thick : CInt, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    val __ptr_1: Ptr[Vector2] = alloc[Vector2](2)
    !(__ptr_1 + 0) = start
    !(__ptr_1 + 1) = end
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawLineEx(dst, (__ptr_1 + 0), (__ptr_1 + 1), thick, (__ptr_0 + 0))
  ...
  */
  def ImageDrawLineV(dst : Ptr[Image], start : Vector2, end : Vector2, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = end
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawLineV(dst, (__ptr_1 + 0), (__ptr_1 + 1), (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawLineV(dst : Ptr[Image], start : Ptr[Vector2], end : Ptr[Vector2], color : Ptr[Color]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawPixel(dst : Ptr[Image], posX : CInt, posY : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageDrawPixel(dst, posX, posY, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawPixelV(dst : Ptr[Image], position : Ptr[Vector2], color : Ptr[Color]): Unit = 
  ...
  */
  def ImageDrawRectangle(dst : Ptr[Image], posX : CInt, posY : CInt, width : CInt, height : CInt, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawRectangle(dst, posX, posY, width, height, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawRectangle(dst : Ptr[Image], posX : CInt, posY : CInt, width : CInt, height : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageDrawRectangle(dst, posX, posY, width, height, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawRectangleLines(dst : Ptr[Image], rec : Ptr[Rectangle], thick : CInt, color : Ptr[Color]): Unit = 
  ...
  */
  def ImageDrawRectangleLines(dst : Ptr[Image], rec : Rectangle, thick : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = rec
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawRectangleLines(dst, (__ptr_1 + 0), thick, (__ptr_0 + 0))
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawRectangleRec(dst : Ptr[Image], rec : Ptr[Rectangle], color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageDrawRectangleRec(dst, rec, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawRectangleV(dst : Ptr[Image], position : Ptr[Vector2], size : Ptr[Vector2], color : Ptr[Color]): Unit = 
  ...
  */
  def ImageDrawRectangleV(dst : Ptr[Image], position : Vector2, size : Vector2, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = size
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawRectangleV(dst, (__ptr_1 + 0), (__ptr_1 + 1), (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawText(dst : Ptr[Image], text : CString, posX : CInt, posY : CInt, fontSize : CInt, color : Ptr[Color]): Unit = 
  ...
  */
  def ImageDrawText(dst : Ptr[Image], text : CString, posX : CInt, posY : CInt, fontSize : CInt, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawText(dst, text, posX, posY, fontSize, (__ptr_0 + 0))
  ...
  */
  def ImageDrawTextEx(dst : Ptr[Image], font : Font, text : CString, position : Vector2, fontSize : Float, spacing : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_2 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_ImageDrawTextEx(dst, (__ptr_1 + 0), text, (__ptr_2 + 0), fontSize, spacing, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawTextEx(dst : Ptr[Image], font : Ptr[Font], text : CString, position : Ptr[Vector2], fontSize : Float, spacing : Float, tint : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageDrawTextEx(dst, font, text, position, fontSize, spacing, tint)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawTriangle(dst : Ptr[Image], v1 : Ptr[Vector2], v2 : Ptr[Vector2], v3 : Ptr[Vector2], color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageDrawTriangle(dst, v1, v2, v3, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawTriangle(dst : Ptr[Image], v1 : Vector2, v2 : Vector2, v3 : Vector2, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    val __ptr_1: Ptr[Vector2] = alloc[Vector2](3)
    !(__ptr_1 + 0) = v1
    !(__ptr_1 + 1) = v2
    !(__ptr_1 + 2) = v3
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawTriangle(dst, (__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawTriangleEx(dst : Ptr[Image], v1 : Vector2, v2 : Vector2, v3 : Vector2, c1 : Color, c2 : Color, c3 : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](3)
    val __ptr_1: Ptr[Vector2] = alloc[Vector2](3)
    !(__ptr_1 + 0) = v1
    !(__ptr_1 + 1) = v2
    ...
    !(__ptr_0 + 1) = c2
    !(__ptr_0 + 2) = c3
    __sn_wrap_libraylib_ImageDrawTriangleEx(dst, (__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawTriangleEx(dst : Ptr[Image], v1 : Ptr[Vector2], v2 : Ptr[Vector2], v3 : Ptr[Vector2], c1 : Ptr[Color], c2 : Ptr[Color], c3 : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageDrawTriangleEx(dst, v1, v2, v3, c1, c2, c3)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawTriangleFan(dst : Ptr[Image], points : Ptr[Vector2], pointCount : CInt, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawTriangleFan(dst, points, pointCount, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawTriangleFan(dst : Ptr[Image], points : Ptr[Vector2], pointCount : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageDrawTriangleFan(dst, points, pointCount, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawTriangleLines(dst : Ptr[Image], v1 : Vector2, v2 : Vector2, v3 : Vector2, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    val __ptr_1: Ptr[Vector2] = alloc[Vector2](3)
    !(__ptr_1 + 0) = v1
    !(__ptr_1 + 1) = v2
    !(__ptr_1 + 2) = v3
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawTriangleLines(dst, (__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawTriangleLines(dst : Ptr[Image], v1 : Ptr[Vector2], v2 : Ptr[Vector2], v3 : Ptr[Vector2], color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageDrawTriangleLines(dst, v1, v2, v3, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawTriangleStrip(dst : Ptr[Image], points : Ptr[Vector2], pointCount : CInt, color : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = color
    __sn_wrap_libraylib_ImageDrawTriangleStrip(dst, points, pointCount, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageDrawTriangleStrip(dst : Ptr[Image], points : Ptr[Vector2], pointCount : CInt, color : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageDrawTriangleStrip(dst, points, pointCount, color)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageFromChannel(image : Ptr[Image], selectedChannel : CInt)(__return : Ptr[Image]): Unit = 
    __sn_wrap_libraylib_ImageFromChannel(image, selectedChannel, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageFromChannel(image : Ptr[Image], selectedChannel : CInt)(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
  ...
  */
  def ImageFromChannel(image : Image, selectedChannel : CInt)(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](2)
    !(__ptr_0 + 0) = image
    __sn_wrap_libraylib_ImageFromChannel((__ptr_0 + 0), selectedChannel, (__ptr_0 + 1))
    !(__ptr_0 + 1)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageFromImage(image : Ptr[Image], rec : Ptr[Rectangle])(__return : Ptr[Image]): Unit = 
  ...
  */
  def ImageFromImage(image : Image, rec : Rectangle)(using Zone): Image = 
    ...
    !(__ptr_0 + 0) = image
    !(__ptr_1 + 0) = rec
    __sn_wrap_libraylib_ImageFromImage((__ptr_0 + 0), (__ptr_1 + 0), (__ptr_0 + 1))
    !(__ptr_0 + 1)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageResizeCanvas(image : Ptr[Image], newWidth : CInt, newHeight : CInt, offsetX : CInt, offsetY : CInt, fill : Ptr[Color]): Unit = 
    __sn_wrap_libraylib_ImageResizeCanvas(image, newWidth, newHeight, offsetX, offsetY, fill)
  ...
  */
  def ImageResizeCanvas(image : Ptr[Image], newWidth : CInt, newHeight : CInt, offsetX : CInt, offsetY : CInt, fill : Color)(using Zone): Unit = 
    val __ptr_0: Ptr[Color] = alloc[Color](1)
    !(__ptr_0 + 0) = fill
    __sn_wrap_libraylib_ImageResizeCanvas(image, newWidth, newHeight, offsetX, offsetY, (__ptr_0 + 0))
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageText(text : CString, fontSize : CInt, color : Ptr[Color])(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageText(text : CString, fontSize : CInt, color : Ptr[Color])(__return : Ptr[Image]): Unit = 
    __sn_wrap_libraylib_ImageText(text, fontSize, color, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageTextEx(font : Ptr[Font], text : CString, fontSize : Float, spacing : Float, tint : Ptr[Color])(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
    __sn_wrap_libraylib_ImageTextEx(font, text, fontSize, spacing, tint, (__ptr_0 + 0))
    !(__ptr_0 + 0)
  ...
  */
  def ImageTextEx(font : Font, text : CString, fontSize : Float, spacing : Float, tint : Color)(using Zone): Image = 
    ...
    !(__ptr_2 + 0) = font
    !(__ptr_0 + 0) = tint
    __sn_wrap_libraylib_ImageTextEx((__ptr_2 + 0), text, fontSize, spacing, (__ptr_0 + 0), (__ptr_1 + 0))
    !(__ptr_1 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def ImageTextEx(font : Ptr[Font], text : CString, fontSize : Float, spacing : Float, tint : Ptr[Color])(__return : Ptr[Image]): Unit = 
    __sn_wrap_libraylib_ImageTextEx(font, text, fontSize, spacing, tint, __return)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def IsModelAnimationValid(model : Ptr[Model], anim : Ptr[ModelAnimation]): Boolean = 
  ...
  */
  def LoadAudioStream(sampleRate : CUnsignedInt, sampleSize : CUnsignedInt, channels : CUnsignedInt)(using Zone): AudioStream = 
    val __ptr_0: Ptr[AudioStream] = alloc[AudioStream](1)
    __sn_wrap_libraylib_LoadAudioStream(sampleRate, sampleSize, channels, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadAudioStream(sampleRate : CUnsignedInt, sampleSize : CUnsignedInt, channels : CUnsignedInt)(__return : Ptr[AudioStream]): Unit = 
    __sn_wrap_libraylib_LoadAudioStream(sampleRate, sampleSize, channels, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadAutomationEventList(fileName : CString)(using Zone): AutomationEventList = 
    val __ptr_0: Ptr[AutomationEventList] = alloc[AutomationEventList](1)
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadAutomationEventList(fileName : CString)(__return : Ptr[AutomationEventList]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadDirectoryFilesEx(basePath : CString, filter : CString, scanSubdirs : Boolean)(__return : Ptr[FilePathList]): Unit = 
    __sn_wrap_libraylib_LoadDirectoryFilesEx(basePath, filter, scanSubdirs, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadDirectoryFilesEx(basePath : CString, filter : CString, scanSubdirs : Boolean)(using Zone): FilePathList = 
    val __ptr_0: Ptr[FilePathList] = alloc[FilePathList](1)
    __sn_wrap_libraylib_LoadDirectoryFilesEx(basePath, filter, scanSubdirs, (__ptr_0 + 0))
    !(__ptr_0 + 0)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadFontEx(fileName : CString, fontSize : CInt, codepoints : Ptr[CInt], codepointCount : CInt)(using Zone): Font = 
    val __ptr_0: Ptr[Font] = alloc[Font](1)
    __sn_wrap_libraylib_LoadFontEx(fileName, fontSize, codepoints, codepointCount, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadFontEx(fileName : CString, fontSize : CInt, codepoints : Ptr[CInt], codepointCount : CInt)(__return : Ptr[Font]): Unit = 
    __sn_wrap_libraylib_LoadFontEx(fileName, fontSize, codepoints, codepointCount, __return)
  ...
  */
  def LoadFontFromImage(image : Image, key : Color, firstChar : CInt)(using Zone): Font = 
    ...
    !(__ptr_1 + 0) = image
    !(__ptr_0 + 0) = key
    __sn_wrap_libraylib_LoadFontFromImage((__ptr_1 + 0), (__ptr_0 + 0), firstChar, (__ptr_2 + 0))
    !(__ptr_2 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadFontFromImage(image : Ptr[Image], key : Ptr[Color], firstChar : CInt)(__return : Ptr[Font]): Unit = 
    __sn_wrap_libraylib_LoadFontFromImage(image, key, firstChar, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadFontFromImage(image : Ptr[Image], key : Ptr[Color], firstChar : CInt)(using Zone): Font = 
    val __ptr_0: Ptr[Font] = alloc[Font](1)
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadFontFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt, fontSize : CInt, codepoints : Ptr[CInt], codepointCount : CInt)(using Zone): Font = 
    val __ptr_0: Ptr[Font] = alloc[Font](1)
    __sn_wrap_libraylib_LoadFontFromMemory(fileType, fileData, dataSize, fontSize, codepoints, codepointCount, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadFontFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt, fontSize : CInt, codepoints : Ptr[CInt], codepointCount : CInt)(__return : Ptr[Font]): Unit = 
    __sn_wrap_libraylib_LoadFontFromMemory(fileType, fileData, dataSize, fontSize, codepoints, codepointCount, __return)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadImageAnim(fileName : CString, frames : Ptr[CInt])(__return : Ptr[Image]): Unit = 
    __sn_wrap_libraylib_LoadImageAnim(fileName, frames, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadImageAnimFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt, frames : Ptr[CInt])(__return : Ptr[Image]): Unit = 
    __sn_wrap_libraylib_LoadImageAnimFromMemory(fileType, fileData, dataSize, frames, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadImageAnimFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt, frames : Ptr[CInt])(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
    __sn_wrap_libraylib_LoadImageAnimFromMemory(fileType, fileData, dataSize, frames, (__ptr_0 + 0))
    !(__ptr_0 + 0)
  ...
  */
  def LoadImageFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt)(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
    __sn_wrap_libraylib_LoadImageFromMemory(fileType, fileData, dataSize, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadImageFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt)(__return : Ptr[Image]): Unit = 
    __sn_wrap_libraylib_LoadImageFromMemory(fileType, fileData, dataSize, __return)
  ...
  */
  def LoadImagePalette(image : Image, maxPaletteSize : CInt, colorCount : Ptr[CInt])(using Zone): Ptr[Color] = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
    !(__ptr_0 + 0) = image
    __sn_wrap_libraylib_LoadImagePalette((__ptr_0 + 0), maxPaletteSize, colorCount)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadImagePalette(image : Ptr[Image], maxPaletteSize : CInt, colorCount : Ptr[CInt]): Ptr[Color] = 
    __sn_wrap_libraylib_LoadImagePalette(image, maxPaletteSize, colorCount)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadImageRaw(fileName : CString, width : CInt, height : CInt, format : CInt, headerSize : CInt)(__return : Ptr[Image]): Unit = 
    __sn_wrap_libraylib_LoadImageRaw(fileName, width, height, format, headerSize, __return)
  ...
  */
  def LoadImageRaw(fileName : CString, width : CInt, height : CInt, format : CInt, headerSize : CInt)(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
    __sn_wrap_libraylib_LoadImageRaw(fileName, width, height, format, headerSize, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadImageSvg(fileNameOrString : CString, width : CInt, height : CInt)(using Zone): Image = 
    val __ptr_0: Ptr[Image] = alloc[Image](1)
    __sn_wrap_libraylib_LoadImageSvg(fileNameOrString, width, height, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadImageSvg(fileNameOrString : CString, width : CInt, height : CInt)(__return : Ptr[Image]): Unit = 
  ...
  */
  def LoadMusicStreamFromMemory(fileType : CString, data : Ptr[CUnsignedChar], dataSize : CInt)(using Zone): Music = 
    val __ptr_0: Ptr[Music] = alloc[Music](1)
    __sn_wrap_libraylib_LoadMusicStreamFromMemory(fileType, data, dataSize, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadMusicStreamFromMemory(fileType : CString, data : Ptr[CUnsignedChar], dataSize : CInt)(__return : Ptr[Music]): Unit = 
    __sn_wrap_libraylib_LoadMusicStreamFromMemory(fileType, data, dataSize, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadRenderTexture(width : CInt, height : CInt)(__return : Ptr[RenderTexture2D]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadShader(vsFileName : CString, fsFileName : CString)(__return : Ptr[Shader]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadShaderFromMemory(vsCode : CString, fsCode : CString)(__return : Ptr[Shader]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadTextureCubemap(image : Ptr[Image], layout : CInt)(using Zone): TextureCubemap = 
    val __ptr_0: Ptr[TextureCubemap] = alloc[TextureCubemap](1)
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadTextureCubemap(image : Ptr[Image], layout : CInt)(__return : Ptr[TextureCubemap]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadVrStereoConfig(device : Ptr[VrDeviceInfo])(__return : Ptr[VrStereoConfig]): Unit = 
  ...
  */
  def LoadWaveFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt)(using Zone): Wave = 
    val __ptr_0: Ptr[Wave] = alloc[Wave](1)
    __sn_wrap_libraylib_LoadWaveFromMemory(fileType, fileData, dataSize, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def LoadWaveFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt)(__return : Ptr[Wave]): Unit = 
    __sn_wrap_libraylib_LoadWaveFromMemory(fileType, fileData, dataSize, __return)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def MeasureTextEx(font : Ptr[Font], text : CString, fontSize : Float, spacing : Float)(__return : Ptr[Vector2]): Unit = 
    __sn_wrap_libraylib_MeasureTextEx(font, text, fontSize, spacing, __return)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def MeasureTextEx(font : Ptr[Font], text : CString, fontSize : Float, spacing : Float)(using Zone): Vector2 = 
    val __ptr_0: Ptr[Vector2] = alloc[Vector2](1)
    __sn_wrap_libraylib_MeasureTextEx(font, text, fontSize, spacing, (__ptr_0 + 0))
    !(__ptr_0 + 0)
  ...
  */
  def MeasureTextEx(font : Font, text : CString, fontSize : Float, spacing : Float)(using Zone): Vector2 = 
    ...
    val __ptr_1: Ptr[Vector2] = alloc[Vector2](1)
    !(__ptr_0 + 0) = font
    __sn_wrap_libraylib_MeasureTextEx((__ptr_0 + 0), text, fontSize, spacing, (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def SetAudioStreamCallback(stream : Ptr[AudioStream], callback : AudioCallback): Unit = 
    __sn_wrap_libraylib_SetAudioStreamCallback(stream, callback)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def SetAudioStreamCallback(stream : AudioStream, callback : AudioCallback)(using Zone): Unit = 
    val __ptr_0: Ptr[AudioStream] = alloc[AudioStream](1)
    !(__ptr_0 + 0) = stream
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def SetMaterialTexture(material : Ptr[Material], mapType : CInt, texture : Ptr[Texture2D]): Unit = 
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def SetShaderValue(shader : Ptr[Shader], locIndex : CInt, value : Ptr[Byte], uniformType : CInt): Unit = 
  ...
  */
  def SetShaderValue(shader : Shader, locIndex : CInt, value : Ptr[Byte], uniformType : CInt)(using Zone): Unit = 
    val __ptr_0: Ptr[Shader] = alloc[Shader](1)
    !(__ptr_0 + 0) = shader
    __sn_wrap_libraylib_SetShaderValue((__ptr_0 + 0), locIndex, value, uniformType)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def SetShaderValueMatrix(shader : Ptr[Shader], locIndex : CInt, mat : Ptr[Matrix]): Unit = 
  ...
  */
  def SetShaderValueMatrix(shader : Shader, locIndex : CInt, mat : Matrix)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = shader
    !(__ptr_0 + 0) = mat
    __sn_wrap_libraylib_SetShaderValueMatrix((__ptr_1 + 0), locIndex, (__ptr_0 + 0))

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def SetShaderValueTexture(shader : Ptr[Shader], locIndex : CInt, texture : Ptr[Texture2D]): Unit = 
  ...
  */
  def SetShaderValueTexture(shader : Shader, locIndex : CInt, texture : Texture2D)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = shader
    !(__ptr_0 + 0) = texture
    __sn_wrap_libraylib_SetShaderValueTexture((__ptr_1 + 0), locIndex, (__ptr_0 + 0))
  ...
  */
  def SetShaderValueV(shader : Shader, locIndex : CInt, value : Ptr[Byte], uniformType : CInt, count : CInt)(using Zone): Unit = 
    val __ptr_0: Ptr[Shader] = alloc[Shader](1)
    !(__ptr_0 + 0) = shader
    __sn_wrap_libraylib_SetShaderValueV((__ptr_0 + 0), locIndex, value, uniformType, count)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def SetShaderValueV(shader : Ptr[Shader], locIndex : CInt, value : Ptr[Byte], uniformType : CInt, count : CInt): Unit = 
    __sn_wrap_libraylib_SetShaderValueV(shader, locIndex, value, uniformType, count)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def UpdateAudioStream(stream : Ptr[AudioStream], data : Ptr[Byte], frameCount : CInt): Unit = 
    __sn_wrap_libraylib_UpdateAudioStream(stream, data, frameCount)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def UpdateCameraPro(camera : Ptr[Camera], movement : Vector3, rotation : Vector3, zoom : Float)(using Zone): Unit = 
    val __ptr_0: Ptr[Vector3] = alloc[Vector3](2)
    !(__ptr_0 + 0) = movement
    !(__ptr_0 + 1) = rotation
    __sn_wrap_libraylib_UpdateCameraPro(camera, (__ptr_0 + 0), (__ptr_0 + 1), zoom)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def UpdateCameraPro(camera : Ptr[Camera], movement : Ptr[Vector3], rotation : Ptr[Vector3], zoom : Float): Unit = 
    __sn_wrap_libraylib_UpdateCameraPro(camera, movement, rotation, zoom)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def UpdateMeshBuffer(mesh : Ptr[Mesh], index : CInt, data : Ptr[Byte], dataSize : CInt, offset : CInt): Unit = 
  ...
  */
  def UpdateMeshBuffer(mesh : Mesh, index : CInt, data : Ptr[Byte], dataSize : CInt, offset : CInt)(using Zone): Unit = 
    val __ptr_0: Ptr[Mesh] = alloc[Mesh](1)
    !(__ptr_0 + 0) = mesh
    __sn_wrap_libraylib_UpdateMeshBuffer((__ptr_0 + 0), index, data, dataSize, offset)

  /**
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def UpdateModelAnimation(model : Ptr[Model], anim : Ptr[ModelAnimation], frame : CInt): Unit = 
  ...
  */
  def UpdateModelAnimation(model : Model, anim : ModelAnimation, frame : CInt)(using Zone): Unit = 
    ...
    !(__ptr_0 + 0) = model
    !(__ptr_1 + 0) = anim
    __sn_wrap_libraylib_UpdateModelAnimation((__ptr_0 + 0), (__ptr_1 + 0), frame)
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/projects/sn-raylib/raylib/src/raylib.h
  */
  def UpdateTextureRec(texture : Ptr[Texture2D], rec : Ptr[Rectangle], pixels : Ptr[Byte]): Unit = 
